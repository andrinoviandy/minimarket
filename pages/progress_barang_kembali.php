...
<div class="content-wrapper">
 ...
 if (isset($_SESSION['id_b'])) {
  ...
  <tr>
    ...
    <td><?php
    $que = mysqli_num_rows(mysqli_query($koneksi, "select *,barang_gudang.id as id_gudang from barang_gudang,barang_gudang_detail,barang_kembali,barang_kembali_detail,barang_kembali_teknisi where barang_gudang.id=barang_gudang_detail.barang_gudang_id and barang_gudang_detail.id=barang_kembali_detail.barang_gudang_detail_id and barang_kembali.id=barang_kembali_detail.barang_kembali_id and barang_kembali_detail.id=barang_kembali_teknisi.barang_kembali_detail_id and barang_gudang.id=".$data['id_gudang'].""));
	echo $que;
	?></td>
    <td>
    <a href="index.php?page=progress_barang_kembali_detail&id_gudang=<?php echo $data['id_gudang']; ?>"><span data-toggle="tooltip" title="Detail" class="fa fa-caret-square-o-right"></span></a>

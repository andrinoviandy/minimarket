...
if (isset($_GET['simpan_barang'])==1) {
	...
	if ($cek4!=0) {
	$s1=mysqli_query($koneksi, "insert into barang_dikirim values('','".$_GET['id']."','".$_SESSION['nama_paket']."','".$_SESSION['no_pengiriman']."','".$_SESSION['tgl_pengiriman']."','".$_SESSION['no_po']."','".$_SESSION['ekspedisi']."','".$_SESSION['via_pengiriman']."','".$_SESSION['estimasi']."','".$_SESSION['biaya_kirim']."','','')");
	if ($s1) {
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Pengiriman Alkes Pengganti</h1><ol class="breadcrumb">
  ...
  <tr>
    ...
    <td align="center">&nbsp;</td>
    <td align="center"><button class="btn btn-warning" data-toggle="modal" data-target="#modal-pilihnoseri<?php echo $data_akse['idd'] ?>">Ganti</button></td>
    </tr>
...
<center><a href="index.php?page=kirim_barang_pengganti"><button name="simpan_barang" class="btn btn-success" type="button"><span class="fa fa-check"></span> Kembali</button></a></center>
<!--

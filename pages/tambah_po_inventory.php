...
if (isset($_POST['simpan_barang'])) {
	...
	window.location='index.php?page=ubah_pembelian_inventory&id=$_GET[id]'</script>";
		}
	}
...
if (isset($_POST['simpan_tambah_aksesoris'])) {
	...
	echo "<script>
alert('Berhasil Di Simpan ! Harap isi kembali Ongkir nya !');	window.location='index.php?page=tambah_po_inventory&id=$_GET[id]'</script>";
	}
...
if (isset($_GET['id_hapus'])) {
	...
	mysqli_query($koneksi, "update barang_pesan_inventory set cost_byair=0, cost_cf=0 where id=$_GET[id]");
	echo "<script type='text/javascript'>
	alert('Harap isi kembali Ongkir nya !');	window.location='index.php?page=tambah_po_inventory&id=$_GET[id]';
		</script>";
	}
?>
...
";
  ...
  <?php }} else {
    ...
    <tr>
    <td colspan="6" align="right" valign="bottom"><strong>Ongkos Kirim =</strong></td>

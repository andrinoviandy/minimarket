...
if (isset($_POST['lapor'])) {
	...
	if ($Result) {
		$data_query=mysqli_fetch_array(mysqli_query($koneksi,"select id from pembeli order by id DESC LIMIT 1"));
		$data_pembeli=$data_query['id'];
		$query_barang_dijual=mysqli_query($koneksi, "insert into barang_dijual values('','".$_POST['tgl_jual']."','".$_GET['id']."','".$_POST['no_seri']."','".$_POST['qty']."','$data_pembeli')");
	
	if ($query_barang_dijual) {
		$update_stok=mysqli_query($koneksi, "update barang_gudang set stok=stok-$_POST[qty] where id=".$_GET['id']."");
...
<div class="content-wrapper">
  ...
  <tr>
    <td align="center" bgcolor="#00FF00"><b><?php echo $i; ?></b></td>
    ...
    <td align="center"><input type="checkbox" class="minimal"></td>
    </tr>
  <?php } ?>
...
<div class="col-md-6"><!-- /.box -->
          ...
          <div class="box-body">
              ...
              <?php $q=mysqli_query($koneksi, "select * from barang_gudang_detail where barang_gudang_id=".$_GET['id']."");
			  while ($d=mysqli_fetch_array($q)) { ?>
              <option value="<?php echo $d['id']; ?>"><?php echo $d['no_seri_brg']; ?></option>
              <?php } ?>
              </select><br />
      ...
      <div class="col-md-6">
        ...
        <div class="box-footer">
          <div class="box-header with-border">
          	...
          	<div class="box-body">
            <?php 
			$data = mysqli_fetch_array(mysqli_query($koneksi,"select nama_brg,merk_brg,tipe_brg,negara_asal,stok from barang_gudang where id=".$_GET['id'].""));
			?>
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <strong>Nama Alkes</strong> :<font class="pull-right"> <?php echo $data['nama_brg']; ?></font>
                </li>
                <li class="list-group-item">
                  <strong>Merk</strong> :<font class="pull-right"> <?php echo $data['merk_brg']; ?></font>
                </li>
                <li class="list-group-item">
                  <strong>Tipe</strong> :<font class="pull-right"> <?php echo $data['tipe_brg']; ?></font>
                </li>
                <li class="list-group-item">
                  <strong>Negara Asal</strong> :<font class="pull-right"> <?php echo $data['negara_asal']; ?></font>
                </li>
                <li class="list-group-item">
                  <strong>Stok</strong> :<font class="pull-right"> <?php echo $data['stok']; ?></font>
                </li>
              </ul>                                 

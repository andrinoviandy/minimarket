...
if (isset($_POST['tambah_header'])) {
	$Result = mysqli_query($koneksi, "update piutang set tgl_input='".$_POST['tgl_input']."',jatuh_tempo='".$_POST['jatuh_tempo']."',nominal='".$_POST['nominal']."',klien='".$_POST['klien']."',deskripsi='".$_POST['deskripsi']."' where id=$_GET[id]");
	if ($Result) {
		echo "<script type='text/javascript'>
		alert('Data Berhasil Di Ubah !');
		window.location='index.php?page=piutang'
		</script>";
		}
	}
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><span class="active">Ubah Piutang</span></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Piutang</li>
        <li class="active">Ubah Piutang</li>
      </ol>
    </section>
        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
             Ubah <span class="active">Piutang / Debit</span>
            </div>
              <div class="box-body">
...
function yesnoCheck() {
    ...
    <?php 
	$q_seri = mysqli_query($koneksi, "select * from kategori_buku_kas where utang_piutang='Piutang' order by no_kategori ASC");
	while ($d_seri=mysqli_fetch_array($q_seri)) {
	?>
    <option <?php if ($data['kategori_buku_kas_id']==$d_seri['id']) {echo "selected";} ?> value="<?php echo $d_seri['id']; ?>" class=""><?php echo $d_seri['no_kategori']." | &nbsp;&nbsp;".$d_seri['nama_kategori']; ?></option>
    <?php } ?>
    </select><br />
              <!--
              <label>Akun</label>

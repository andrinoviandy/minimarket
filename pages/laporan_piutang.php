                                ...
                                <div class="pull pull-left">
                                    <table align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-control select2" id="status_jatuh_tempo" name="status_jatuh_tempo">
                                            ...
                                            <td>
                                                <select class="form-control select2" id="status_lunas" name="status_lunas">
                                                    <option value="all">Semua</option>
...
<script>
    let id_pelanggan = 'all';
    let status_jatuh_tempo = 'all';
    let status_lunas = 'all';

    async function getDataPelanggan() {
        await $.get("data/select-pelanggan2.php",
            function(data) {
    ...
    function lihatData() {
        ...
        setTimeout(() => {
            ...
            status_jatuh_tempo = $('#status_jatuh_tempo').val()

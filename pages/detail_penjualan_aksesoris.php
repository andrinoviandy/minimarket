        ...
        <div class="box box-warning"><!-- /.chat -->
          <div class="box-footer">
            <div class="box-body table-responsive no-padding">
              ...
              <button name="tambah_laporan" class="btn btn-warning" type="submit"><span class="fa fa-plus"></span> Kirim Alkes</button></a><br /><br />--><span class="pull pull-right">
                  <table>
                    <tr>
                ...
                <table width="100%" id="example1" class="table table-bordered table-hover">
                  ...
                  <?php
                  // membuka file JSON
                  $file = file_get_contents("http://localhost/ALKES_2/json/detail_penjualan_aksesoris.php?id=$_GET[id]");
                      ...
                      <td>
                        <table width="100%" border="0">
                          ...
                          while ($d1 = mysqli_fetch_array($q)) {
                            $n++;
                            if ($n % 2 == 0) {
                              if ($d1['status_kembali_ke_gudang'] == 1) {
                                $col = "#FF0000";
                              } else {
                                $col = "#CCCCCC";
                              }

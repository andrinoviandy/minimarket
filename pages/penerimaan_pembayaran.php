...
if (isset($_GET['id_hapus'])) {
	...
	echo "<script>window.location='index.php?page=biaya_lain'</script>";
	}
?>
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>Penerimaan &amp; Pembayaran</h1>
      <ol class="breadcrumb">
...
?>
  ...
  <tr>
    <td valign="center"><?php echo date("d M Y",strtotime($json[$i]['tanggal']));?></td>
    <td><?php echo $json[$i]['nama_akun']; ?></td>
    
    <td>
    <?php echo $json[$i]['nama_biaya'];  ?></td>
    <td><?php echo $json[$i]['jumlah']; ?></td>
    <td><?php echo "Rp ".number_format($json[$i]['harga'],2,',','.'); ?></td>
    <td><?php echo "Rp ".number_format($tambahan,2,',','.'); ?></td>
    <td>
      ...
      <a href="index.php?page=biaya_lain&id_ubah=<?php echo $json[$i]['idd']; ?>#openUbah"><span data-toggle="tooltip" title="Ubah" class="fa fa-edit"></span></a><br /> 
    </td>
  </tr>
  <?php } ?>
</table><br />

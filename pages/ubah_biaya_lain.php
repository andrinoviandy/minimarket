              ...
              <form method="post">
                ...
                <div class="well">
                  ...
                  <select required name="coa_sub_id" class="form-control" id="coa_sub_id">
                    ...
                    ?>
                      <option <?php if ($data['coa_sub_id'] == $row1['idd']) {
                                echo "selected";
                              } ?> id="coa_sub_id" class="<?php echo $row1['coa_id']; ?>" value="<?php echo $row1['idd'] ?>"><?php echo $row1['nama_sub_grup']; ?></option>
                    <?php } ?>
                  </select><br />
                  <select name="coa_sub_akun_id" class="form-control select2" style="width:100%" id="coa_sub_akun_id">
                    ...
                    ?>
                      <option <?php if ($data['coa_sub_akun_id'] == $row1['idd']) {
                                echo "selected";
                              } ?> id="coa_sub_akun_id" class="<?php echo $row1['coa_sub_id']; ?>" value="<?php echo $row1['idd'] ?>"><?php echo $row1['nama_akun']; ?></option>
                    <?php } ?>
                  </select>

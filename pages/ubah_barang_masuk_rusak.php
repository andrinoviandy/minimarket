        ...
        <section class="col-lg-8 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
			  ...
			  echo "Stok Rusak : ".$stok_rusak; ?></font><br />
...
$queryy = mysqli_query($koneksi, "select *,barang_gudang_detail.id as idd,barang_gudang_po.id as id_po from barang_gudang_detail,barang_gudang_po,barang_gudang where barang_gudang.id=barang_gudang_detail.barang_gudang_id and barang_gudang_po.id=barang_gudang_detail.barang_gudang_po_id and status_kerusakan=1 and barang_gudang_detail.barang_gudang_id=".$_GET['id']." and $_GET[pilihan] like '%$_GET[kunci]%' order by no_po_gudang DESC");
	}
	else {

...
// membuka file JSON
$file = file_get_contents("http://localhost/ALKES/json/piutang_set.php");
...
<?php if ($json[$i]['status_lunas']==0){$b="#FF0000";} else {$b="#00CC66";} ?>
  <tr>
    ...
    <td>
      ...
      <?php } ?>
	  <?php if ($json[$i]['status_lunas']==0) { ?>
      <a href="index.php?page=bayar_piutang_set&id=<?php echo $json[$i]['idd']; ?>"><small data-toggle="tooltip" title="Bayar" class="label bg-green"><span class="fa fa-plus"></span> Pembayaran</small></a>
      <?php } else { ?>
      <a href="index.php?page=bayar_piutang_set&id=<?php echo $json[$i]['idd']; ?>"><small data-toggle="tooltip" title="Batalkan" class="label bg-yellow">Riwayat Pembayaran</small></a>
      <?php } ?>

...
if (isset($_POST['simpan_barang'])) {
		...
		alert('Data Aksesoris Berhasil Disimpan !');		window.location='index.php?page=simpan_tambah_akse5&id=$_GET[id]';
		</script>
		";
		}
	}
...
if (isset($_POST['simpan_akse'])) {
		...
		if ($s) {
			echo "<script type='text/javascript'>
		alert('Data Aksesoris Berhasil Disimpan !');		window.location='index.php?page=ubah_akse2&id=$_GET[id]';
		</script>
		";
...
<div class="content-wrapper">
  ...
  <?php } ?>
  <tr>
    <td colspan="7" align="center"><br /><br /><!--<button name="simpan_barang" class="btn btn-success" type="submit"><span class="fa fa-plus"></span> Simpan & Tambah Lagi</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--><button name="simpan_akse" class="btn btn-success" type="submit"><span class="fa fa-plus"></span> Simpan</button></td>
    </tr>

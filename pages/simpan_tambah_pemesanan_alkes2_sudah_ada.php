...
<script>
  ...
  function simpanFix() {
    ...
    $.ajax({
      type: "post",
      url: "data/simpan-barang-pesan2.php",
      data: data,
        ...
        if (response == 'S') {
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              window.location.href = 'index.php?page=pembelian_alkes2'
            }
          })
  ...
  function simpanHash() {
    ...
    $.ajax({
      type: "post",
      url: "data/simpan-barang-pesan2-hash.php",
      data: data,
      enctype: 'multipart/form-data',
      processData: false,
      contentType: false,
  ...
  function hapus(id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.post("data/hapus-barang-pesan2-hash.php", {
            id_hapus: id
          },
          function(data) {
            if (data == 'S') {

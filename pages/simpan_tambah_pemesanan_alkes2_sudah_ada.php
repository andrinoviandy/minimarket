...
if (isset($_POST['tambah_header'])) {
	...
	window.location='index.php?page=simpan_tambah_pemesanan_alkes2_sudah_ada'</script>";
		}
}
...
if (isset($_POST['simpan_tambah_aksesoris'])) {
	...
	echo "<script>window.location='index.php?page=simpan_tambah_pemesanan_alkes2_sudah_ada'</script>";
	}
...
function sum_total_keseluruhan() {
      ...
      if (!isNaN(result)) {
		 ...
		 document.getElementById('nominall').value = total_rupiah;
      }
}
</script>
<div class="content-wrapper">
  ...
  <?php }} else {
    ...
    <td align="center" valign="top"><input name="cost_byair" id="cost_byair" class="form-control" type="text" placeholder="" onkeyup="sum_total_keseluruhan();" size="10" required="required"/></td>
    <td align="center"></td>
    <td align="center"></td>
    </tr>
    <tr>
    <td colspan="8" align="right" valign="bottom"><strong>Total Keseluruhan =</strong></td>
    <td align="center" valign="top"><input id="cost_cf" name="cost_cf" class="form-control" type="text" placeholder="" size="10" readonly="readonly"/></td>
    <td align="center"></td>
    <td align="center"></td>
    </tr>
    <tr>
      <td colspan="8" align="right" valign="bottom">Nilai Tukar (Satuan Dalam Rupiah) =</td>
      <td align="center" valign="top"><input id="nilai_tukar" name="nilai_tukar" class="form-control" type="text" required="required" value="" placeholder="" size="10" onkeyup="sum_total_keseluruhan();"/></td>
      <td align="center"></td>
      <td align="center"></td>
    </tr>
    <tr>
      <td colspan="8" align="right" valign="bottom"><strong>Total Keseluruhan</strong> (Rupiah) =</td>
      <td align="center" valign="top"><input name="dalam_rupiah" id="dalam_rupiah" type="text" required="required" class="form-control" value="" placeholder="Auto" size="10" readonly="readonly"/></td>
      <td align="center"></td>
      <td align="center"></td>
    </tr>
                </table>
...
function yesnoCheck() {
    if (document.getElementById('yesCheck').checked) {
        document.getElementById('ifYes').style.display = 'block';
              ...
              <label>Nominal (Dalam Rupiah)</label>
              <input id="nominall" name="nominal" class="form-control" type="text" placeholder="Dalam Rupiah" value=""><br />
              <label>Klien</label>
              ...
              <div class="modal-footer">
                ...
                <?php if (isset($_SESSION['user_administrator']) or isset($_SESSION['adminpodalam']) or isset($_SESSION['adminpoluar'])) { ?><button name="tambah_header" class="btn btn-success" type="submit"><span class="fa fa-plus"></span> Simpan</button><?php } ?>
              </div>

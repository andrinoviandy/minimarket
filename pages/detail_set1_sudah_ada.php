...
<br />
                <center>
                <a href="index.php?page=simpan_tambah_pemesanan_alkes2_set_sudah_ada"><button name="simpan_barang" class="btn btn-success" type="submit"><span class="fa fa-check"></span> Kembali ke halaman sebelumnya</button></a></center>
              </div>
              </div>
            </div>
          </div>

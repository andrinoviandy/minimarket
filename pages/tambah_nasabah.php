...
if (isset($_POST['tambah_header'])) {
  ...
  $Result = mysqli_query($koneksi, "insert into nasabah values(UUID(),'$_POST[nik]','$_POST[nama_nasabah]','$_POST[tempat_lahir]','$_POST[tanggal_lahir]','$_POST[alamat]','$_POST[email]','$_POST[no_hp]','1')");
  if ($Result) {

...
if (isset($_POST['simpan_barang'])) {
			echo "<script type='text/javascript'>		window.location='index.php?page=simpan_tambah_ke_stok_akse2&id=$_GET[id]&id_pesan=$_GET[id_pesan]&id_detail=$_GET[id_detail]';
		</script>
		";
...
<div class="content-wrapper">
  ...
  <tr>
    ...
    <td>
    <?php
	$data2 = mysqli_fetch_array(mysqli_query($koneksi, "select * from barang_pesan_akse where id=".$_GET['id_pesan'].""));
	?> 

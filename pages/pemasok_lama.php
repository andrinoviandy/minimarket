...
<div class="content-wrapper">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            <div class="box-footer">
              ...
              <a href="index.php?page=tambah_pemasok">
    ...
    <tr>
        ...
        <th  valign="top">Email Pemasok</th>
...
?>
  ...
  <tr>
    <td valign="center"><?php echo $json[$i]['nama_pemasok'];?></td>
    <td><?php echo $json[$i]['alamat']; ?></td>
    
    <td>
    <?php echo $json[$i]['email_pemasok'];  ?></td>
    <td>
      <a href="index.php?page=pemasok&id_hapus=<?php echo $json[$i]['id']; ?>" onclick="return confirm('Anda Yakin Akan Menghapus Item Ini ?')"><span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></a>&nbsp;&nbsp;
      <a href="index.php?page=pemasok&id_ubah=<?php echo $json[$i]['id']; ?>#openUbah"><span data-toggle="tooltip" title="Ubah" class="fa fa-edit"></span></a>&nbsp;&nbsp;
    </td>
  </tr>
  <?php } ?>
</table><br />

...
if (isset($_POST['lapor'])) {
	$jml = mysqli_num_rows(mysqli_query($koneksi, "select * from barang_dijual_inventory where no_po_jual='".$_POST['no_faktur']."'"));
	if ($jml==0) {
	mysqli_query($koneksi, "delete from barang_dijual_inventory_qty_hash where akun_id=".$_SESSION['id']."");
		echo "<script type='text/javascript'>
		window.location='index.php?page=simpan_jual_inventory';
		</script>";

...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="index.php?page=pemusnahan_alkes">Pemusnahan Alkes</a></li>
        <li class="active"><a href="index.php?page=tambah_pemusnahan">Tambah Pemusnahan Alkes</a></li>
        <li class="active">Dari Dalam</li>
      </ol>
    </section>
            ...
            <div class="box-header with-border">
              ...
              <select name="item" class="form-control">
				...
				while ($d=mysqli_fetch_array($q)) {
				 ?>
                <option value="<?php echo $d['nama_brg']; ?>"><?php echo $d['nama_brg']; ?></option>
                <?php } ?>
                </select><br />

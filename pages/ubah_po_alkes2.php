...
";
    ...
    <td align="center"><input id="merk_akse" name="merk_akse" class="form-control" type="text"  placeholder="Merk" value="<?php echo $data_akse['merk_brg']; ?>" disabled="disabled"/></td>

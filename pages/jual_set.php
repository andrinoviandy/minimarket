...
if (isset($_GET['id_batal'])) {
	...
	if ($cek==0) {
	$del=mysqli_query($koneksi, "delete from utang_piutang where no_faktur_no_po='".$sel['no_po_jual']."'");
...
echo "<script>window.location='index.php?page=jual_barang_uang;</script>";
		}
	else {
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-info"><!-- /.chat -->
            <div class="box-footer">
              ...
              <a href="index.php?page=jual_set#openPilihan">
...
// membuka file JSON
$file = file_get_contents("http://localhost/ALKES/json/jual_barang_uang.php");
...
?>
  <tr>
	...
	?></td><!--<table width="100%" border="0">
      <?php 
	  $q2=mysqli_query($koneksi, "select no_po_gudang from barang_gudang,barang_gudang_po,barang_dijual_qty,barang_dijual where barang_gudang.id=barang_gudang_po.barang_gudang_id and barang_gudang.id=barang_dijual_qty.barang_gudang_id and barang_dijual.id=barang_dijual_qty.barang_dijual_id and barang_dijual.id=".$json[$i]['idd']." group by barang_gudang.id");
	  $n=0;
    ...
    <table width="100%" border="0">
      <?php 
	  $q2=mysqli_query($koneksi, "select * from barang_dijual_qty,barang_gudang,barang_dijual where barang_gudang.id=barang_dijual_qty.barang_gudang_id and barang_dijual.id=barang_dijual_qty.barang_dijual_id and barang_dijual.id=".$json[$i]['idd']."");
	  $n=0;
	  while ($d1=mysqli_fetch_array($q2)) {
	  $n++;
	  if ($n%2==0) {
    ...
    <td><a href="index.php?page=jual_barang_uang&id=<?php echo $json[$i]['pembeli_id']; ?>#openDetailPembeli" style="color:#060" data-toggle="tooltip" title="Detail Dinas/RS/Puskesmas/Klinik/Dll"><?php 

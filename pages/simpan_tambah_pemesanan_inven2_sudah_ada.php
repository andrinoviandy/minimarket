...
if (isset($_POST['tambah_header'])) {
  ...
  if ($ce != 0) {
	...
	window.location='index.php?page=simpan_tambah_pemesanan_inven2_sudah_ada'</script>";
  }
}
...
if (isset($_POST['simpan_tambah_aksesoris'])) {
  ...
  echo "<script>window.location='index.php?page=simpan_tambah_pemesanan_inven2_sudah_ada'</script>";
}
...
";
                  ...
                  $no = 0;
                  $q_akse = mysqli_query($koneksi, "select *,barang_pesan_inventory_detail_hash.id as idd from barang_pesan_inventory_detail_hash,mata_uang where mata_uang.id=barang_pesan_inventory_detail_hash.mata_uang_id and akun_id=" . $_SESSION['id'] . "");
                  ...
                  ?>
                      <tr>
                        ...
                        <td align="center"><a href="index.php?page=simpan_tambah_pemesanan_inven2_sudah_ada&id_hapus=<?php echo $data_akse['idd']; ?>" onclick="return confirm('Yakin Akan Menghapus Item Ini ?')"><span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></a></td>
                      </tr>
                  <?php }
                  } else {

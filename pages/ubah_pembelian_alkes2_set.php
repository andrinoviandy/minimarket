...
if (isset($_POST['simpan_perubahan'])) {
	$ppn=$_POST['ppn']/100;
	$Result = mysqli_query($koneksi, "update barang_pesan_set set tgl_po_pesan='".$_POST['tgl_po']."',no_po_pesan='".$_POST['no_po']."',ppn='".$_POST['ppn']."',cara_pembayaran='".$_POST['cara_pembayaran']."', mata_uang_id='".$_POST['mata_uang']."',alamat_pengiriman='".str_replace("\n","<br>",$_POST['alamat_pengiriman'])."',jalur_pengiriman='".$_POST['jalur_pengiriman']."',estimasi_pengiriman='".$_POST['estimasi_pengiriman']."', catatan='".$_POST['catatan']."',total_price_ppn=total_price-(total_price*".$ppn.") where id=".$_GET['id']."");
	if ($Result) {
		mysqli_query($koneksi, "update barang_pesan_set_detail set mata_uang_id=".$_POST['mata_uang']." where barang_pesan_set_id=".$_GET['id']."");
		echo "<script type='text/javascript'>
		alert('Data Berhasil Diubah !');
		window.location='index.php?page=pembelian_alkes2_set'
		</script>";
		}
	}
?>
...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <a href="index.php?page=tambah_po_alkes2_set&id=<?php echo $_GET['id']; ?>">
  ...
  <?php
  $q = mysqli_query($koneksi, "select *,barang_pesan_set_detail.id as idd from barang_gudang_set,barang_pesan_set_detail,barang_pesan_set,mata_uang where barang_gudang_set.id=barang_pesan_set_detail.barang_gudang_set_id and barang_pesan_set.id=barang_pesan_set_detail.barang_pesan_set_id and mata_uang.id=barang_pesan_set_detail.mata_uang_id and barang_pesan_set.id=".$_GET['id']."");
  $no=0;
  ...
  <tr>
    ...
    <td><?php echo $d['simbol']." ".number_format($d['cost_byair'],0,',',',').".00"; ?></td>
        ...
        <section class="col-lg-6 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              ...
              <a href="index.php?page=ubah_pembelian_alkes2_set&id=<?php echo $_GET['id']; ?>#openBaru"><button name="ubah_baru" class="btn btn-success" type="submit"><span class="fa fa-edit"></span> Ubah Dengan Data Yang Baru</button></a>
              <a href="index.php?page=ubah_pembelian_alkes2_set&id=<?php echo $_GET['id']; ?>#openSudahAda"><button name="ubah_sudah_ada" class="btn btn-success pull pull-right" type="submit"><span class="fa fa-edit"></span> Ubah Dengan Data Yang Sudah Ada</button></a>
              <br /><br />
...
if ($sel) {
	...
	echo "<script type='text/javascript'>
		 window.location='index.php?page=ubah_pembelian_alkes2_set&id=$_GET[id]'
		</script>";
	}
}
?>

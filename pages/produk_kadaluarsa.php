<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Produk Kadaluarsa</h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Produk Kadaluarsa</li>
        </ol>
    </section>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <div class="">
                                <div class="pull pull-left">
                                    <form method="post" onsubmit="lihatData(); return false;">
                                        <table align="center">
                                            <tr>
                                                <td>&nbsp; Masukkan Satuan Hari Kedepan &nbsp;</td>
                                                <td><input type="number" name="expired_to" id="expired_to" class="form-control" /></td>

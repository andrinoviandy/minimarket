...
<div class="col-md-5"><!-- /.box -->
  ...
  <?php
  $q = mysqli_query($koneksi, "select *,barang_dijual_qty_set.id as idd from barang_dijual_qty_set,barang_gudang_set_2 where barang_gudang_set_2.id=barang_dijual_qty_set.barang_gudang_set2_id and barang_dijual_set_id=".$_GET['id']."");
  $no=0;

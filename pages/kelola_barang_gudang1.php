...
if (isset($_POST['simpan_barang'])) {
	...
	window.location='index.php?page=detail_barang_gudang1&id=$_GET[id]'</script>";
		}
	}
...
<div class="content-wrapper">
  ...
  <thead>
    <tr>
      ...
      <td valign="bottom"><strong>Total Harga
      </strong>
  ...
  <tr>
    ...
    <td><?php echo $data_akse['simbol']." ".number_format($data_akse['harga_total'],2,',','.'); ?></td>
...
function sum<?php echo $data_akse['idd']; ?>() {
  ...
  <?php }} else {
    ...
    <td align="left" valign="top"><input name="cost_cf" id="cost_cf" class="form-control" type="text" required="required" value="<?php echo $data['cost_cf']; ?>" placeholder="" size="20" onkeyup="sum_total_keseluruhan();"/></td>
    <td align="center"></td>
    </tr>
    <tr>
      <td height="24" colspan="8" align="right" valign="bottom">Nilai Tukar (satuan dalam rupiah) =</td>
      <td align="left" valign="top"><input id="nilai_tukar" name="nilai_tukar" class="form-control" type="text"  readonly="readonly" value="1" placeholder="" size="20" onkeyup="sum_total_keseluruhan();"/></td>
      <td align="center"></td>
    </tr>
    <tr>
	  ...
	  ?>
      <input name="dalam_rupiah" id="dalam_rupiah" type="text" required class="form-control" value="<?php echo $total_rupiah; ?>" placeholder="Auto" size="20" readonly="readonly"/></td>
      <td align="center"></td>
    </tr>
                </table>
                </div>

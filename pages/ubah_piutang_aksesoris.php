<?php
$data=mysqli_fetch_array(mysqli_query($koneksi, "select * from utang_piutang_aksesoris where id=$_GET[id]"));

if (isset($_POST['tambah_header'])) {
	$Result = mysqli_query($koneksi, "update utang_piutang_aksesoris set tgl_input='".$_POST['tgl_input']."',jatuh_tempo='".$_POST['jatuh_tempo']."',nominal='".$_POST['nominal']."',klien='".$_POST['klien']."',deskripsi='".$_POST['deskripsi']."' where id=$_GET[id]");
	if ($Result) {
		echo "<script type='text/javascript'>
		alert('Data Berhasil Di Ubah !');
		window.location='index.php?page=piutang_aksesoris'
		</script>";
		}
	}
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><span class="active">Ubah Piutang Aksesoris</span></h1>
      <ol class="breadcrumb">
...
function yesnoCheck() {
    ...
    if (document.getElementById('yesCheck').checked) {
        ...
        document.getElementById('ifYes').style.display = 'block';
              ...
              <br />
              <label>No PO</label>
              <input name="no_po" class="form-control" type="text" placeholder="" disabled="disabled" value="<?php echo $data['no_faktur_no_po_akse']; ?>"><br />
              <label>Nominal</label>

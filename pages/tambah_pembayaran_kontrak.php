...
if (isset($_POST['tambah_header'])) {
	$Result = mysqli_query($koneksi, "insert into kontrak_pembayaran values('','".$_POST['kontrak_id']."','".$_POST['tgl']."','".str_replace(".","",$_POST['jumlah'])."','".$_POST['deskripsi']."')");
	if ($Result) {
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><span class="active">Tambah Pembayaran</span></h1><ol class="breadcrumb">
        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Tambah <span class="active">Pembayaran</span></h3>
            </div>
              <div class="box-body">
              <form method="post">
              ...
              <label>Nominal </label>
              <input name="jumlah" class="form-control" type="text" placeholder="" value="" required="required" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);"><br />

...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Riwayat Pemasukan/Piutang</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Pengaturan</li>
        <li class="active">Riwayat Piutang/Pemasukan</li>
      </ol>
    </section>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Riwayat Pemasukan/Piutang</h3><a href="cetak_riwayat_pemasukan.php"><button class="btn btn-success pull pull-right"><span class="fa fa-print"></span> &nbsp;Print Excel</button></a></div><div class="box-body">
  ...
  <tr>
    ...
    <td>
    <a href="index.php?page=detail_riwayat_pemasukan&id=<?php echo $data['id_up']; ?>"><button class="btn btn-success">Detail</button>
    </td>
  </tr>

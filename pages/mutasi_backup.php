...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Mutasi Alkes</h1><ol class="breadcrumb">
  ...
  <tr>
    ...
    <td><?php 
	$stok_sudah_mutasi = mysqli_fetch_array(mysqli_query($koneksi,"select stok as stok_sudah from barang_gudang_po where no_po_gudang='".$d['no_po_pesan']."' and barang_gudang_id=".$d['barang_gudang_id'].""));

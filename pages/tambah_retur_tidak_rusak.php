...
if (isset($_POST['tambah_spk_masuk'])) {
	echo "<script type='text/javascript'>
		...
		$_SESSION['no_retur']=$_POST['nomor_retur'];
		$_SESSION['tgl_retur']=$_POST['tgl_retur'];
		$_SESSION['no_po_id']=$_POST['nomor_po'];
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tambah Retur Pengembalian
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="index.php?page=barang_masuk">Tambah Retur Pengembalian</a></li></ol></section>

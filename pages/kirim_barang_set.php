...
if (isset($_GET['id_hapus'])) {
	$up=mysqli_query($koneksi, "update barang_dikirim_set,barang_dikirim_detail_set,barang_dijual_qty_set,barang_gudang_set_2 set barang_dijual_qty_set.status_kirim=0,qty=qty+qty_jual where barang_dikirim_set.id=barang_dikirim_detail_set.barang_dikirim_set_id and barang_dijual_qty_set.id=barang_dikirim_detail_set.barang_dijual_qty_set_id and barang_gudang_set_2.id=barang_dijual_qty_set.barang_gudang_set2_id and barang_dikirim_set.id=".$_GET['id_hapus']."");
	$del1=mysqli_query($koneksi, "delete from barang_dikirim_detail_set where barang_dikirim_set_id=".$_GET['id_hapus']."");
	$del2=mysqli_query($koneksi, "delete from barang_dikirim_set where id=".$_GET['id_hapus']."");
	if ($up and $del1 and $del2) {
		echo "<script>

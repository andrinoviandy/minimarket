  ...
  if ($up) {
    echo "<script>
      Swal.fire({
        ...
        window.location.href = '?page=pembelian_akse2';
      })
      </script>";
  } else {
    echo "<script>
        ...
        <div class="box box-success">
          ...
          <div class="box-footer">
            ...
            <div class="box-body">
              ...
              <?php
              $cek_uang = mysqli_num_rows(mysqli_query($koneksi, "select * from barang_pesan_akse,utang_piutang_aksesoris,utang_piutang_aksesoris_bayar where barang_pesan_akse.no_po_pesan=utang_piutang_aksesoris.no_faktur_no_po_akse and utang_piutang_aksesoris.id=utang_piutang_aksesoris_bayar.utang_piutang_aksesoris_id and no_po_pesan='" . $data['no_po_pesan'] . "'"));
              $j_cek = mysqli_num_rows(mysqli_query($koneksi, "select * from barang_pesan_akse_detail,aksesoris where aksesoris.id=barang_pesan_akse_detail.aksesoris_id and barang_pesan_akse_detail.barang_pesan_akse_id=" . $_GET['id'] . " and status_ke_stok=1"));

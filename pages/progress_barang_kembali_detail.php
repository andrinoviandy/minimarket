...
$file = file_get_contents("http://localhost/ALKES/json/progress_barang_kembali_detail.php?id_gudang=$_GET[id_gudang]&id_b=$_SESSION[id_b]");	
	}
else {
$file = file_get_contents("http://localhost/ALKES/json/progress_barang_kembali_detail.php?id_gudang=$_GET[id_gudang]");
}
...
?>
                  <tr>
                    ...
                    <td><?php if ($json[$i]['status_progress_k_p']==1) {echo "SELESAI"; } else if($json[$i]['status_progress_k_p']==0) {echo "BELUM SELESAI";} ?></td>
                    <td><?php if ($json[$i]['status_kerusakan']==1) {echo "RUSAK"; } else if($json[$i]['status_kerusakan']==2) {echo "Tidak Layak Jual & Kembali Ke Pabrik";} else {echo "Layak Dijual & Kembali Ke Gudang";} ?></td>

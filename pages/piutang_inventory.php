        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            <div class="box-footer">
              ...
              <a href="index.php?page=tambah_piutang">
...
// membuka file JSON
$file = file_get_contents("http://localhost/ALKES/json/piutang_inventory.php");
...
<?php if ($json[$i]['status_lunas']==0){$b="#FF0000";} else {$b="#00CC66";} ?>
  <tr>
    ...
    <td><?php echo $json[$i]['no_faktur_no_po_inven']; ?></td>
    ...
    <td>
      ...
      <?php }*/ ?>
	  <?php if ($json[$i]['status_lunas']==0) { ?>
      <a href="index.php?page=bayar_piutang_inventory&id=<?php echo $json[$i]['idd']; ?>"><small data-toggle="tooltip" title="Bayar" class="label bg-green"><span class="fa fa-plus"></span> Pembayaran</small></a>
      <?php } else { ?>
      <a href="index.php?page=bayar_piutang_inventory&id=<?php echo $json[$i]['idd']; ?>"><small data-toggle="tooltip" title="Batalkan" class="label bg-yellow">Riwayat Pembayaran</small></a>
      <?php } ?>

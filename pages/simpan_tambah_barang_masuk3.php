...
if (isset($_POST['simpan_barang'])) {
  echo "<script type='text/javascript'>		window.location='index.php?page=simpan_tambah_barang_masuk4';
		</script>
		";
                ...
                <form method="post" enctype="multipart/form-data">
                  <div class="table-responsive">
                    <table width="100%" id="" class="table table-bordered table-hover">
                      <thead>
                        <tr>
                          <th valign="bottom"><strong>Jenis Satuan</strong></th>
                      ...
                      ?>
                      <tr>
                        <td><?php echo $_SESSION['jenis_satuan']; ?>

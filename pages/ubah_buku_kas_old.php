    ...
    <div class="row">
      ...
      <th valign="top">No. Lot</th>-->
                    ...
                    if (isset($_GET['pilihan']) and isset($_GET['kunci'])) {
                      $file = file_get_contents("http://localhost/ALKES_2_2/json/riwayat_hutang_piutang.php?id=$_GET[id]&pilihan=$_GET[pilihan]&kunci=" . str_replace(" ", "%20", $_GET['kunci']) . "");
                    } elseif (isset($_GET['tgl1']) and isset($_GET['tgl2'])) {
                      $file = file_get_contents("http://localhost/ALKES_2_2/json/riwayat_hutang_piutang.php?id=$_GET[id]&tgl1=" . $_GET['tgl1'] . "&tgl2=" . $_GET['tgl2'] . "");
                    } else {
                      $file = file_get_contents("http://localhost/ALKES_2_2/json/riwayat_hutang_piutang.php?id=$_GET[id]");
                    }

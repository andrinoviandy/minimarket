...
$data = mysqli_fetch_array(mysqli_query($koneksi, "select
                    ...
                    from
                        ...
                        buku_kas c on c.id = a.buku_kas_id where a.id = '$_GET[id]'"));
?>
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>Riwayat Transaksi Pinjaman</h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Riwayat Transaksi Pinjaman</li>
        </ol>
    </section>
                                ...
                                <div class="table-responsive no-padding">
                                    <table width="100%" id="" class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo number_format($data['nominal_pinjam'], 0, ',', '.');  ?></td>
                                            <td><?php echo $data['keterangan'];  ?></td>
                                            <td><?php echo $data['nama_akun'];  ?></td>
                                            <td><?php echo $data['flag_lunas'] == 0 ? 'Belum Lunas' : 'Lunas';  ?></td>
                                            <td><?php echo $data['operator'];  ?></td>
                                            <td><?php echo number_format($data['total_angsuran'], 0, ',', '.');  ?></td>
                                            <td><?php echo number_format($data['total_kekurangan'], 0, ',', '.');  ?></td>
                                            <td><?php echo number_format($data['total_angsuran_bunga'], 0, ',', '.');  ?></td>
                                            <td><?php echo number_format($data['total_keuntungan'], 0, ',', '.');  ?></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>

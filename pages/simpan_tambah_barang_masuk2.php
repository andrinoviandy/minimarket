						...
						<div class="box-body">
							<div class="">
								...
								<form method="post" enctype="multipart/form-data">
										...
										<table width="100%" id="" class="table table-bordered table-hover">
											<thead>
												<tr>
													...
													<th valign="bottom">Kategori Barang</th>
									...
									<center><button name="simpan_barang_baru" class="btn btn-success" type="submit"><span class="fa fa-plus"></span> Simpan & Tambah Barang Baru</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button name="simpan_barang" class="btn btn-success" type="submit"><span class="fa fa-plus"></span> Simpan & Tambah Lagi</button>
										<?php if ($_SESSION['kategori_brg'] == 'Satuan') { ?>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button name="simpan_akse" class="btn btn-success" type="submit"><span class="fa fa-plus"></span> Selesai - Simpan - Lanjut Tambah Aksesoris</button>
										<?php } ?>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button name="simpan_selesai" class="btn btn-success" type="submit"><span class="fa fa-plus"></span> Selesai - Simpan</button>
									</center>
									<br />
								</form>
							</div>

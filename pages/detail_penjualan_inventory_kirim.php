...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Detail Pengiriman Barang Inventory
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Detail Pengiriman Barang Inventory</li>
      </ol>
    </section>
  ...
  <thead>
    <tr>
      <th align="center">&nbsp;</th>
        ...
        <th>No Pengiriman</th>
        <th>No PO</th>
      <th><strong>Nama Alkes <span class="pull pull-right">Qty Jual</span></strong></th>
  ...
  <?php
// membuka file JSON
$file = file_get_contents("http://localhost/ALKES/json/kirim_inventory.php?id=$_GET[id]");

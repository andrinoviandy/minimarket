...
if (isset($_GET['id_hapus'])) {
	$del2 = mysqli_query($koneksi, "delete from kontrak where id=".$_GET['id_hapus']."");
	}
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Dokumen Kontrak</li>
      </ol>
    </section>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            <div class="box-footer">
              ...
              <a href="index.php?page=tambah_dokumen_kontrak">
  ...
  <thead>
    <tr>
      ...
      <th width="" valign="top">Waktu Kontrak / Deadline</th>
      <th width="" align="center" valign="top">Nilai Kontrak</th>
  ...
  <?php
  $file = file_get_contents("http://localhost/ALKES/json/dokumen_kontrak.php");

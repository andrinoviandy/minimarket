...
// membuka file JSON
$file = file_get_contents("http://localhost/ALKES/json/utang_inventory.php");
...
<?php if ($json[$i]['status_lunas']==0){$b="#FF0000";} else {$b="#00CC66";} ?>
  <tr>
    ...
    <td>
      ...
      <a href="index.php?page=utang_inventory&id_hapus=<?php echo $json[$i]['idd']; ?>" onclick="return confirm('Anda Yakin Akan Menghapus Item Ini ?')"><span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></a>&nbsp;&nbsp;
      <a href="index.php?page=ubah_utang_inventory&id=<?php echo $json[$i]['idd']; ?>"><span data-toggle="tooltip" title="Ubah" class="fa fa-edit"></span></a><br />
      <?php }*/ ?>
	  <?php if ($json[$i]['status_lunas']==0) { ?>
      <a href="index.php?page=bayar_utang_inventory&id=<?php echo $json[$i]['idd']; ?>"><small data-toggle="tooltip" title="Bayar" class="label bg-green">Bayar</small></a>
      <?php } else { ?>
      <a href="index.php?page=bayar_utang_inventory&id=<?php echo $json[$i]['idd']; ?>"><small data-toggle="tooltip" title="Riwayat Pembayaran" class="label bg-yellow"> Riwayat Pembayaran </small></a>
      <?php } ?>

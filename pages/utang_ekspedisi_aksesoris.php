...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Biaya Ekspedisi (Aksesoris)</h1>
      <ol class="breadcrumb">
...
?>
  <tr>
    <td align="center"><?php echo $i+1; ?></td>
     <?php
    $jumlah_bayar = mysqli_fetch_array(mysqli_query($koneksi, "select sum(nominal) as total from bayar_ekspedisi_aksesoris where aksesoris_kirim_id=$json[$i][idd]"));
    ...
    <td>
      <?php echo $json[$i]['po_no_akse']; ?></td>
    <td><?php 
	$data3=mysqli_fetch_array(mysqli_query($koneksi, "select nama_pembeli,kontak_rs from pembeli,aksesoris_jual,aksesoris_kirim,aksesoris_kirim_detail,aksesoris_jual_qty where pembeli.id=aksesoris_jual.pembeli_id and aksesoris_kirim.id=aksesoris_kirim_detail.aksesoris_kirim_id and aksesoris_jual_qty.id=aksesoris_kirim_detail.aksesoris_jual_qty_id and aksesoris_jual.id=aksesoris_jual_qty.aksesoris_jual_id and aksesoris_kirim.id=".$json[$i]['idd'].""));
	...
	?>
    <td>
      <a href="index.php?page=bayar_ekspedisi_aksesoris&id=<?php echo $json[$i]['idd']; ?>"><small data-toggle="tooltip" title="Riwayat Pembayaran" class="label bg-green"> Riwayat Pembayaran </small></a>
    </td>
  </tr>
  <?php } ?>
</table><br />

...
if (isset($_POST['tambah_header'])) {
	...
	window.location='index.php?page=simpan_tambah_pemesanan_akse_sudah_ada'</script>";
		}
}
...
if (isset($_POST['simpan_tambah_aksesoris'])) {
	...
	echo "<script>window.location='index.php?page=simpan_tambah_pemesanan_akse_sudah_ada'</script>";
	}
...
";
  ...
  <tr>
    ...
    <td align="center"><a href="index.php?page=simpan_tambah_pemesanan_akse_sudah_ada&id_hapus=<?php echo $data_akse['idd']; ?>" onclick="return confirm('Yakin Akan Menghapus Item Ini ?')"><span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></a></td>
    </tr>
  <?php }} else {

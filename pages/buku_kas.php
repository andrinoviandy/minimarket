...
<div class="content-wrapper">
  ...
  <tr>
    ...
    <td><?php echo $data['nama_akun']; ?></td>
      ...
      <div class="pull pull-right">Saldo Riil :</div></td>
    <!--<td></td>
	...
	if ($jm1==0 and $jm2==0) {
	?>
      <a href="index.php?page=buku_kas&id_hapus=<?php echo $data['idd']; ?>" onclick="return confirm('Anda Yakin Akan Menghapus Item Ini ? Riwayat Pembayaran Pada Buku Ini Juga Akan Ikut Terhapus !')"><span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></a>&nbsp;
      <?php } ?>
      <a href="#" data-toggle="modal" data-target="#modal-ubah<?php echo $data['idd']; ?>"><span data-toggle="tooltip" title="Ubah" class="fa fa-edit"></span></a>&nbsp;<a href="index.php?page=ubah_buku_kas&id=<?php echo $data['idd']; ?>"><span data-toggle="tooltip" title="Detail" class="fa fa-caret-square-o-right"></span></a><!--&nbsp;<a target="_blank" href="cetak_rekapan_alkes2.php?id=<?php echo $data['idd']; ?>"><span data-toggle="tooltip" title="Print" class="fa fa-print"></span></a>
      -->
      <!-- Tombol Jual -->

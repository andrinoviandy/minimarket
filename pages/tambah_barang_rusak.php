...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Alkes Rusak</h1><ol class="breadcrumb">
          ...
          <div class="box box-success"><!-- /.chat -->
            <div class="box-footer">
              ...
              <!--<a href="index.php?page=tambah_barang_masuk"><button name="tambah_laporan" class="btn btn-success" type="submit"><span class="fa fa-plus"></span> Tambah Barang</button></a>--><font align="left" size="+2">
                  Tambah Data Alkes Rusak</font> <br />
...
";
      ...
      <td align="center">
        <select required name="no_seri" id="no_seri" class="form-control select2">
	...
	?>
          <option id="no_seri" value="<?php echo $d_seri['idd']; ?>" class="<?php echo $d_seri['barang_gudang_id']; ?>" <?php if ($d_seri['status_terjual']==1) { echo "disabled"; } ?>><?php echo $d_seri['no_seri_brg']." ".$d_seri['nama_set']; ?></option>
          <?php } ?>
          </select>
  ...
  <tr>
    <td colspan="7"><strong>Deskripsi Kerusakan</strong><br />
      <textarea class="form-control" rows="3" name="kerusakan" ></textarea></td>
    </tr>
  <tr>
    <td colspan="7" align="center"><button name="simpan_tambah_aksesoris" class="btn btn-success" type="submit"><span class="fa fa-check"></span> Simpan</button></td>
    </tr>

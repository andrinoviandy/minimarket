...
if (isset($_POST['tambah_header'])) {
	...
	if ($ce!=0) {
	$insert_princ = mysqli_query($koneksi, "insert into principle values('','".$_SESSION['nama_princ']."','".str_replace("\n","<br>",$_SESSION['alamat_princ'])."','".$_SESSION['telp_princ']."','".$_SESSION['fax_princ']."','".$_SESSION['attn_princ']."')");
	...
	window.location='index.php?page=simpan_tambah_pemesanan_akse2'</script>";
		}
}
...
if (isset($_POST['simpan_tambah_aksesoris'])) {
	...
	echo "<script>window.location='index.php?page=simpan_tambah_pemesanan_akse2'</script>";
	}
...
<div class="content-wrapper">
  ...
  <tr>
    ...
    <td><?php echo str_replace("\n","<br>",$_SESSION['alamat_princ'])."<br>Telp : ".$_SESSION['telp_princ']."<br>Fax : ".$_SESSION['fax_princ']."<br>Attn : ".$_SESSION['attn_princ']; ?></td>
...
";
    ...
    <td align="center"><input id="harga_perunit" name="harga_perunit" class="form-control" type="text" placeholder="Harus Angka" required="required" size="10" onkeyup="sum();"/></td>
  ...
  <tr>
    ...
    <td align="center"><a href="index.php?page=simpan_tambah_pemesanan_akse2&id_hapus=<?php echo $data_akse['idd']; ?>" onclick="return confirm('Yakin Akan Menghapus Item Ini ?')"><span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></a></td>
    </tr>
  <?php }} else {
...
<center>
<a href="index.php?page=simpan_tambah_pemesanan_akse2#open_utang"><button name="simpan_barang" class="btn btn-success" type="button"><span class="fa fa-plus"></span> Simpan</button></a>&nbsp;&nbsp;<a href="index.php?page=pembelian_akse2"><button name="batal" class="btn btn-success" type="button"><span class="fa  fa-times-circle"></span> Batal</button></a></center>
...
function yesnoCheck() {
    if (document.getElementById('yesCheck').checked) {
        document.getElementById('ifYes').style.display = 'block';
              ...
              <label>Nominal</label>
              <input name="nominal" class="form-control" type="text" placeholder="Dalam Rupiah" value=""><br />
              <label>Klien</label>

...
<div class="content-wrapper">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-body table-responsive no-padding">
              ...
              -->
              <a href="index.php?page=pembuatan_spk2&id=<?php echo $_GET['id']; ?>"><button class="btn btn-success">Kembali Ke Halaman Sebelumnya</button></a>
              <br /><br />
  ...
  <?php
	  ...
	  $query = mysqli_query($koneksi, "select * from kategori_job,tb_laporan_kerusakan,tb_laporan_kerusakan_detail,alat_pelatihan,alat_uji_detail,barang_teknisi_detail,barang_dikirim_detail,barang_gudang_detail,barang_gudang,tb_teknisi,tb_maintenance,tb_maintenance_detail,pembeli where kategori_job.id=tb_laporan_kerusakan_detail.kategori_job_id and tb_laporan_kerusakan.id=tb_laporan_kerusakan_detail.tb_laporan_kerusakan_id and alat_pelatihan.id=tb_laporan_kerusakan_detail.alat_pelatihan_id and alat_uji_detail.id=alat_pelatihan.alat_uji_detail_id and barang_teknisi_detail.id=alat_uji_detail.barang_teknisi_detail_id and barang_dikirim_detail.id=barang_teknisi_detail.barang_dikirim_detail_id and barang_gudang_detail.id=barang_dikirim_detail.barang_gudang_detail_id and barang_gudang.id=barang_gudang_detail.barang_gudang_id and tb_maintenance.id=tb_maintenance_detail.tb_maintenance_id and tb_teknisi.id=tb_maintenance.teknisi_id and tb_laporan_kerusakan_detail.id=tb_maintenance_detail.tb_laporan_kerusakan_detail_id and pembeli.id=tb_laporan_kerusakan.pembeli_id and tb_maintenance.id=".$_GET['id_detail']."");

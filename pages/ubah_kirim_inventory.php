...
$q1=mysqli_fetch_array(mysqli_query($koneksi, "select *,barang_dikirim_inventory.id as idd from barang_dikirim_inventory where id=".$_GET['id'].""));

if (isset($_POST['tambah_laporan'])) {
	$Result = mysqli_query($koneksi, "update barang_dikirim_inventory set nama_paket='".$_POST['nama_paket']."', no_pengiriman='".$_POST['no_pengiriman']."', tgl_kirim='".$_POST['tgl_kirim']."', ekspedisi='".$_POST['ekspedisi']."', via_pengiriman='".$_POST['via_kirim']."', estimasi_barang_sampai='".$_POST['estimasi']."', biaya_pengiriman='".$_POST['biaya_jasa']."', tgl_sampai='".$_POST['tgl_sampai']."' where id=".$_GET['id']."");
	if ($Result) {

...
if (isset($_POST['cetak_excel'])) {
	echo "<script>window.location=cetak_laporan_neraca.php?tgl=$_POST[tgl]</script>";
	}
...
if (isset($_POST['lihat'])) {
	echo "<script type='text/javascript'>
	window.location='index.php?page=laporan_neraca&tgl=$_POST[tgl]';
	</script>";
	}
?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Neraca</li></ol></section>
    ...
    <table align="center">
      <tr>
        ...
        <td>Tanggal Periode &nbsp;</td>
          <td><input type="date" name="tgl" class="form-control" value="<?php if (isset($_GET['tgl'])) { echo $_GET['tgl'];} ?>" autofocus="autofocus"/></td>
        ...
        <?php if (isset($_GET['tgl'])) { ?>
        <td>
        <a href="?page=laporan_neraca"><button name="lihat2" type="button" class="btn btn-warning">Ulangi</button></a></td>
        <?php } ?>
		<?php if (isset($_GET['tgl'])) { ?>
        <td>
        ...
        <td>
          <a target="_blank" href="print_laporan_neraca.php?tgl=<?php echo $_GET['tgl'] ?>"><div data-toggle="tooltip" title="Print" class="btn btn-danger"><span class="fa fa-print"></span></div></a>
        </td>
        <?php } ?>
      </tr>
    </table>
            ...
            <div class="box-header with-border" style="background-color:#FC9">
              ...
              <h3 class="box-title pull pull-right">
				  ...
				  $aset11_d=mysqli_fetch_array(mysqli_query($koneksi, "select sum(saldo) as total from keuangan,keuangan_detail,coa,coa_sub where keuangan.id=keuangan_detail.keuangan_id and coa.id=keuangan_detail.coa_id and coa_sub.id=keuangan_detail.coa_sub_id and db_cr='db' and coa.id=1 and "));
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
				  ...
				  echo number_format($saldo1['total'],2,',','.');
				  ?></a>
                  </font>
                </li>
                <?php } ?>

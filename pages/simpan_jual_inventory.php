...
if (isset($_POST['tambah_header'])) {
	...
	window.location='index.php?page=simpan_jual_inventory'</script>";
		}
}
...
if (isset($_POST['simpan_tambah_aksesoris'])) {
	...
	if ($simpan) {
		echo "<script>window.location='index.php?page=simpan_jual_inventory'</script>";
		}
	} else {
...
function yesnoCheck() {
    if (document.getElementById('yesCheck').checked) {
     ...
     <label>No PO</label>
              ...
              <label>Klien</label>
              <input name="klien" class="form-control" type="text" placeholder="" value="<?php echo $_SESSION['pembeli'];  ?>" required="required"><br />

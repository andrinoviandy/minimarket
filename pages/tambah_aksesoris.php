...
if (isset($_POST['tambah_laporan'])) {
	$Result = mysqli_query($koneksi, "insert into space_part values('','".$_POST['nama_sp']."','".$_POST['merk']."','".$_POST['tipe']."','".$_POST['no_seri']."','".$_POST['stok']."', '".$_POST['deskripsi']."','".$_POST['harga_satuan']."')");
	if ($Result) {
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Spare Part</li></ol></section>
        ...
        <section class="col-lg-6 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Tambah Spare Part</h3>
            </div>
              <div class="box-body">
              <form method="post">
              <input name="nama_sp" class="form-control" type="text" required placeholder="Nama Spare Part" autofocus><br />
              ...
              <input name="no_seri" class="form-control" type="text" placeholder="Nomor Seri" required><br />

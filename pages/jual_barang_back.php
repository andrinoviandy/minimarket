...
<div class="content-wrapper">
  ...
  <thead>
    <tr>
      ...
      <th align="center">Sisa Belum Di Kirim</th>
...
// membuka file JSON
$file = file_get_contents("http://localhost/ALKES/json/jual_barang.php");
...
?>
  <tr>
	...
	if (!isset($_SESSION['user_admin_keuangan'])) { ?> 
      ...
      <a href="index.php?page=detail_jual_barang&id=<?php echo $json[$i]['idd']; ?>"><small data-toggle="tooltip" title="Detail Kirim" class="label bg-yellow">Lihat</small></a>
      <?php } ?>
    </td>
  </tr>
  <?php } ?>
...
if (isset($_POST['kirim_barang'])) {
	...
	echo "<script type='text/javascript'>
		window.location='index.php?page=pilih_no_seri&id=".$_GET['id']."';
		</script>";
} 
/*

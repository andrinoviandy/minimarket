...
if (isset($_POST['tambah_spk_masuk'])) {
	$query_spk=mysqli_query($koneksi, "insert into barang_teknisi values('','".$_POST['tgl_spk']."','".$_POST['id_teknisi']."','".$_POST['id_barang']."')");
	if ($query_spk) {
...
";        
					...
					echo '
						<option value="' . $row['idd'] . '">' . $row['nama_brg'] . '</option>';    
...
";    
              ...
              <br />
              Merk
              <input name="merk" id="merk" class="form-control" type="text" placeholder="Merk" readonly="readonly" disabled="disabled">
              
              <br />
              Tipe
              <input name="tipe" id="tipe" class="form-control" type="text" placeholder="Tipe" readonly="readonly" disabled="disabled"><br />
              NIE
              <input name="nie" id="nie" class="form-control" type="text" placeholder="Nomor Ijin Edar (NIE)" readonly="readonly" disabled="disabled"><br />
              No Bath
     ...
     <input name="jalan" id="jalan" class="form-control" type="text" placeholder="kelurahan" disabled="disabled"><br />
             ...
             <input name="nama_pemakai" id="nama_pemakai" class="form-control" type="text" placeholder="kelurahan" disabled="disabled"><br />
              Kontak
             <input name="kontak" id="kontak" class="form-control" type="text" placeholder="kelurahan" disabled="disabled"><br />
              Email

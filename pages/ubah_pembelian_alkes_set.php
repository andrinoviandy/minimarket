<?php
$query = mysqli_query($koneksi, "select *,principle.id as id_principle from barang_pesan_set,principle,mata_uang where principle.id=barang_pesan_set.principle_id and mata_uang.id=barang_pesan_set.mata_uang_id and barang_pesan_set.id='".$_GET['id']."'");
...
if (isset($_GET['id_hapus'])) {
	mysqli_query($koneksi, "delete from barang_pesan_detail_set where id=".$_GET['id_hapus']."");
	}

if (isset($_POST['simpan_perubahan'])) {
	$ppn=$_POST['ppn']/100;
	$Result = mysqli_query($koneksi, "update barang_pesan_set set tgl_po_pesan='".$_POST['tgl_po']."',no_po_pesan='".$_POST['no_po']."',ppn='".$_POST['ppn']."',cara_pembayaran='".$_POST['cara_pembayaran']."',mata_uang_id='".$_POST['mata_uang']."',alamat_pengiriman='".str_replace("\n","<br>",$_POST['alamat_pengiriman'])."',jalur_pengiriman='".$_POST['jalur_pengiriman']."', catatan='".$_POST['catatan']."',total_price_ppn=total_price-(total_price*".$ppn.") where id=".$_GET['id']."");
	if ($Result) {
		mysqli_query($koneksi, "update barang_pesan_detail_set set mata_uang_id=".$_POST['mata_uang']." where barang_pesan_set_id=".$_GET['id']."");
		echo "<script type='text/javascript'>
		alert('Data Berhasil Diubah !');
		window.location='index.php?page=pembelian_alkes_set'
		</script>";
		}
	}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Ubah Pemesanan Alkes</h1><ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="index.php?page=barang_masuk">Pemesanan</a></li>
        <li class="active">Ubah Pemesanan Alkes</li></ol></section>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Detail Alkes</h3></div><div class="box-body">
              <a href="index.php?page=tambah_po_alkes_set&id=<?php echo $_GET['id']; ?>">
              <button class="btn btn-success"><span class="fa fa-edit"></span> &nbsp;Kelola</button></a>
              <strong class="pull pull-right">
              <table>
  <tr>
    <td><strong>Total Price + PPn</strong></td>
    <td>:</td>
    <td><?php echo "<font style='font-size:20px'>".$data['simbol']." ".number_format($data['total_price_ppn'],0,',',',').".00"."</font>"; ?></td>
  </tr>
  <tr>
    <td><strong>Ongkir</strong></td>
    <td>:</td>
    <td><?php echo "<font style='font-size:20px'>".$data['simbol']." ".number_format($data['cost_cf'],0,',',',').".00"."</font>"; ?></td>
  </tr>
  <tr>
    <td><strong class="pull pull-right">Total Keseluruhan</strong></td>
    <td>:</td>
    <td><?php echo "<font style='font-size:20px'>".$data['simbol']." ".number_format($data['cost_cf'],0,',',',').".00"."</font>"; ?></td>
  </tr>
</table>
  ...
  <?php
  $q = mysqli_query($koneksi, "select *,barang_pesan_detail_set.id as idd from barang_gudang_set,barang_pesan_detail_set,barang_pesan_set,mata_uang where barang_gudang_set.id=barang_pesan_detail_set.barang_gudang_set_id and barang_pesan_set.id=barang_pesan_detail_set.barang_pesan_set_id and mata_uang.id=barang_pesan_detail_set.mata_uang_id and barang_pesan_set.id=".$_GET['id']."");
  $no=0;
  ...
  <tr>
    ...
    <?php } else { echo "Sudah Masuk Stok"; } ?>
    </td>
    -->
  </tr>
  <?php } ?>
        ...
        <section class="col-lg-6 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            <div class="box-footer">
            <div class="box-header with-border">
              <h3 class="box-title">Ubah Detail Pesanan</h3></div><div class="box-body">
                <form method="post">
                  <label>Tgl PO</label>
	...
	?>
    <option value="<?php echo $d_mu['id']; ?>" <?php if ($d_mu['id']==$data['mata_uang_id']) {echo "selected";} ?>><?php echo $d_mu['jenis_mu']; ?></option>
    <?php } ?>
    </select><br />
...
<?php echo str_replace("<br>","\n",$data['alamat_pengiriman']); ?>
        ...
        <section class="col-lg-6 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            <div class="box-footer">
            <div class="box-header with-border">
              <h3 class="box-title">Ubah Principle</h3></div><div class="box-body">
              ...
              <a href="index.php?page=ubah_pembelian_alkes_set&id=<?php echo $_GET['id']; ?>#openBaru"><button name="ubah_baru" class="btn btn-success" type="submit"><span class="fa fa-edit"></span> Ubah Dengan Data Yang Baru</button></a>
              <a href="index.php?page=ubah_pembelian_alkes_set&id=<?php echo $_GET['id']; ?>#openSudahAda"><button name="ubah_sudah_ada" class="btn btn-success pull pull-right" type="submit"><span class="fa fa-edit"></span> Ubah Dengan Data Yang Sudah Ada</button></a>
              <br /><br />
...
$nilai_m = $max['id_max'];
if ($sel) {
	$upd_brg_pesan = mysqli_query($koneksi, "update barang_pesan_set set principle_id=$nilai_m where id=$_GET[id]");
	echo "<script type='text/javascript'>
		 window.location='index.php?page=ubah_pembelian_alkes_set&id=$_GET[id]'
		</script>";
	}
}
?>
...
$upd_brg_pesan = mysqli_query($koneksi, "update barang_pesan_set set principle_id=".$_POST['id_akse']." where id=$_GET[id]");
if ($upd_brg_pesan) {

...
if (isset($_POST['tambah_aksesoris'])) {
	...
	echo "<script type='text/javascript'>
	window.location='index.php?page=simpan_tambah_pemesanan_alkes_sudah_ada';
		</script>";
	} else {
		echo "<script type='text/javascript'>
        ...
        <section class="col-lg-6 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              ...
              Mata Uang
              <select class="form-control select2" style="width:100%" name="mata_uang">
    <?php 
	$q_uang=mysqli_query($koneksi, "select * from mata_uang order by id ASC");
	while ($d_mu=mysqli_fetch_array($q_uang)) {
	?>
    <option <?php if ($d_mu['jenis_mu']=='Rupiah') {echo "selected";} ?> value="<?php echo $d_mu['id']; ?>"><?php echo $d_mu['jenis_mu']; ?></option>
    <?php } ?>
    </select><br /><br />
              Alamat Pengiriman
...
";
        ...
        <?php 
		$jsArray .= "dtBrg['" . $d['id'] . "'] = {alamat_princ:'".addslashes(str_replace("<br>","[Enter]",substr($d['alamat_principle'],0,15)))."............',
    ...
    <br />
             ...
             Attn Principle
              <input name="attn_princ2" type="text" disabled="disabled" class="form-control" id="attn_princ2" placeholder="" ><br />

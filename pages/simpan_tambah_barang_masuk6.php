								...
								<form method="post" enctype="multipart/form-data">
									<div class="table-responsive">
										<table width="100%" id="" class="table table-bordered table-hover">
											...
											<tr>
												...
												<td><?php if ($data['jenis_barang'] == 0) {
														echo "Bukan E-Katalog";
													} else {
														echo "E-Katalog";
													} ?></td>
									...
									<div class="table-responsive">
										<table width="100%" id="" class="table table-bordered table-hover">
											<thead>
												<tr>
													<td width="15%" align="center" valign="bottom">Data Alkes Ke-</td>

													<td width="31%" align="center" valign="bottom"><strong>No. Bath
														</strong></td>
													<td width="28%" align="center" valign="bottom"><strong>No. Lot
														</strong></td>
													<td width="26%" align="center" valign="bottom"><strong>No. Seri</strong></td>
													<td width="26%" align="center" valign="bottom"><strong>Kode QRCode</strong></td>

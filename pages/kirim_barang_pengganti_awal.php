...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <button class="btn btn-success" data-toggle="modal" data-target="#modal-tambah"><i class="fa fa-plus"></i> Tambah Data</button>
...
?>
  <tr>
    ...
    <div class="input-group-btn">
                  <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown">Aksi
    ...
    <li><a href="index.php?page=riwayat_panggilan&id=<?php echo $json[$i]['idd']; ?>"><span data-toggle="tooltip" title="Riwayat Panggilan CS" class="fa fa-phone-square"></span> Riw. Pangg. CS</a></li>
    <?php } ?>
    <li><a href="index.php?page=ubah_barang_kirim&id=<?php echo $json[$i]['idd']; ?>"><span data-toggle="tooltip" title="Ubah" class="fa fa-edit"></span> Ubah</a></li><!--<a target="blank" href="cetak_surat_perintah_instalasi.php?id=<?php echo $json[$i]['idd']; ?>"><span data-toggle="tooltip" title="Cetak Surat Perintah Instalasi" class="glyphicon glyphicon-print"></span></a><a href="cetak_surat_perintah_instalasi.php?id=<?php echo $json[$i]['idd']; ?>"><span data-toggle="tooltip" title="Buat Surat Perintah Instalasi" class="fa fa-file-pdf-o"></span></a>--><li>
      ...
      <li><a data-toggle="modal" data-target="#modal-cetak-surat-jalan<?php echo $json[$i]['idd']; ?>"><span data-toggle="tooltip" title="Cetak Surat Jalan" class="fa fa-print"></span> Cet. Surat Jalan</a>
	  </li>
...
<div class="modal fade" id="modal-tambah">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
              <label>No PO</label>
                <select class="form-control select2" name="no_po" required style="width:100%">
                <option value="">...</option>
                <?php 
				$q_po = mysqli_query($koneksi, "select *,barang_dikirim.id as idd from barang_dikirim,barang_dikirim_detail where barang_dikirim.id=barang_dikirim_detail.barang_dikirim_id and status_batal=1 group by no_po_jual order by no_po_jual ASC");
				while ($d = mysqli_fetch_array($q_po)){ ?>
                <option value="<?php echo $d['idd'] ?>"><?php echo $d['no_po_jual'] ?></option>
                <?php } ?>
                </select>
                <br /><br />
     ...
     <input id="input" type="text" placeholder="" name="biaya_kirim" required="required">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-success" name="kirim_barang">Tambah</button>
              </div>
              </form>
            </div>
            <!-- /.modal-content -->

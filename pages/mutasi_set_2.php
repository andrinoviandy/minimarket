...
if (isset($_POST['simpan_akse'])) {
	...
	$simpan_po=mysqli_query($koneksi, "insert into barang_gudang_po_set values('','$nilai_maks1','".$_SESSION['tgl_masuk']."','".$_SESSION['no_po']."','".$_GET['stok_set']."')");
	
	$maks = mysqli_fetch_array(mysqli_query($koneksi, "select max(id) as mak from barang_gudang_po_set"));
	
	$nilai_maks=$maks['mak'];
	
	for ($i=0; $i<$_GET['stok_set']; $i++) {
...
<div class="content-wrapper">
  ...
  <tr>
    ...
    <td bgcolor=""><?php echo $_GET['stok_set']; ?></td>
  ...
  <thead>
    <tr>
      <td align="center" valign="bottom">Data  Ke-</td>
      
      <td align="center" valign="bottom"><strong>Nama Barang</strong></td>
      <td align="center" valign="bottom"><strong>Harga Beli</strong></td>
      <td align="center" valign="bottom"><strong>Harga Jual</strong></td>
  ...
  <?php 
  for ($i=0; $i<$_SESSION['stok_dalam_1set']; $i++) {
  ?>
  <tr>
    <td align="center" bgcolor="#00FF00"><b><?php echo $i+1; ?></b></td>
    
    <td align="center"><input name="nama_brg[]" class="form-control" type="text" placeholder="" required="required"/></td>
    <td align="center"><input name="harga_beli[]" class="form-control" type="text" placeholder="" /></td>
    <td align="center"><input name="harga_jual[]" class="form-control" type="text" placeholder="" /></td>
    <td align="center"><strong>
      <input id="[]" name="qty[]" class="form-control" type="text" required placeholder="" />
    </strong></td>
    </tr>
  <?php } ?>
  <tr>

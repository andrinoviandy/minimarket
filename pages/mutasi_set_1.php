...
if (isset($_POST['simpan_barang'])) {
	echo "<script type='text/javascript'>		window.location='index.php?page=mutasi_set_2&id=$_GET[id]&stok_set=$_GET[stok_set]&id_gudang=$_GET[id_gudang]&id_detail=$_GET[id_detail]';
		</script>
		";
...
<div class="content-wrapper">
  ...
  <tr>
    ...
    <td><input name="stok_set" class="form-control" type="text"  placeholder="" size="4" required="required" value="<?php echo $_GET['stok_set']; ?>" disabled="disabled"/></td>

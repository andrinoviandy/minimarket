...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Riwayat Pengeluaran/Hutang</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Pengaturan</li>
        <li class="active">Riwayat Hutang/Pengeluaran</li>
      </ol>
    </section>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Riwayat Pengeluaran/Hutang</h3><a href="cetak_riwayat_pengeluaran.php"><button class="btn btn-success pull pull-right"><span class="fa fa-print"></span> &nbsp;Print Excel</button></a></div><div class="box-body">
  ...
  <thead>
    <tr>
      ...
      <th width="5%" align="center" valign="top"><strong>Aksi</strong></th>
      <!--<th valign="top">NIE</th>
      <th valign="top">No. Bath</th>
      <th valign="top">No. Lot</th>-->
  ...
  <tr>
    ...
    <td><a href="index.php?page=detail_riwayat_pengeluaran&id=<?php echo $data['id_up']; ?>"><button class="btn btn-success">Detail</button></a>
    </td>
  </tr>
  <?php } ?>
</table>

            ...
            <div class="box-header with-border">
              ...
              <div class="table-responsive">
                <table width="100%" id="" class="table table-bordered table-hover">
                  ...
                  <?php
                  $q = mysqli_query($koneksi, "select *,barang_pesan_detail.id as idd from barang_gudang,barang_pesan_detail,barang_pesan where barang_gudang.id=barang_pesan_detail.barang_gudang_id and barang_pesan.id=barang_pesan_detail.barang_pesan_id and barang_pesan_detail.id=" . $_GET['id_detail'] . "");
                  $no = 0;

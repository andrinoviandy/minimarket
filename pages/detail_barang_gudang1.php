...
if ($upd_brg_pesan) {
	...
	echo "<script type='text/javascript'>
		 window.location='index.php?page=detail_barang_gudang1&id=$_GET[id]'
		</script>";
	}
}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Detail Pemesanan Alkes</h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="index.php?page=barang_masuk">Pemesanan</a></li>
        <li class="active">Detail Pemesanan Alkes</li></ol></section>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              ...
              <a href="index.php?page=kelola_barang_gudang1&id=<?php echo $_GET['id']; ?>">

                            ...
                            <div class="">
                                <div class="pull pull-left">
                                    <table align="center">
                                        <tr>
                                            <td>Tgl Mulai &nbsp;</td>
                                            <td><input type="date" name="tgl1" id="tgl1" class="form-control" value="<?php if (isset($_GET['tgl1'])) {
                                                                                                                            echo $_GET['tgl1'];
                                                                                                                        } ?>" /></td>
                                            <td>&nbsp; Tgl Sampai &nbsp;</td>
...
<script>
    let tglPenjualan1, tglPenjualan2;
    ...
    $(document).ready(function() {
        ...
        tglPenjualan1 = formattedDate
        tglPenjualan2 = formattedDate

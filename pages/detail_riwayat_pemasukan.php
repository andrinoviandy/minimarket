      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <a href="index.php?page=riwayat_pemasukan"><button class="btn btn-success">Kembali</button></a><a href="cetak_detail_riwayat_pemasukan.php?id_up=<?php echo $_GET['id']; ?>"><button class="btn btn-success pull pull-right"><span class="fa fa-print"></span> &nbsp;Print Excel</button></a>

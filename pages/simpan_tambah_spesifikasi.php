...
if (isset($_POST['simpan_tambah_aksesoris'])) {
	$simpan = mysqli_query($koneksi, "insert into spesifikasi values('','".$_GET['id']."','".$_POST['judul']."','".str_replace("\n","<br>",$_POST['spesifikasi'])."')");
	if ($simpan) {
		echo "<script>window.location='index.php?page=simpan_tambah_spesifikasi&id=$_GET[id]'</script>";
		}
	}
...
<div class="content-wrapper">
  ...
  <thead>
    <tr>
      ...
      <td align="center" valign="bottom"><strong>Judul      
        Spesifikasi</strong>
      <td align="center" valign="bottom"><strong>Penjabaran Spesifikasi</strong>
  ...
  <tr>
    ...
    <td align="center"><input name="judul" class="form-control" type="text" placeholder="Judul" /></td>
    <td align="center">
  ...
  $no=0;
  $q_akse = mysqli_query($koneksi, "select *,spesifikasi.id as idd from spesifikasi where barang_gudang_id=".$_GET['id']."");
  ...
  <tr>
    <td><?php echo $no; ?></td>
    <td><?php echo $data_akse['judul_spesifikasi']; ?></td>

...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      dari <u><?php $da = mysqli_fetch_array(mysqli_query($koneksi, "select * from pembeli,alamat_provinsi,alamat_kecamatan,alamat_kabupaten where alamat_provinsi.id=pembeli.provinsi_id and alamat_kabupaten.id=pembeli.kabupaten_id and alamat_kecamatan.id=pembeli.kecamatan_id and pembeli.id=$_GET[id]")); echo $da['nama_pembeli']; ?></u></h1>
      <ol class="breadcrumb">
...
$file = file_get_contents("http://localhost/ALKES/json/pembuatan_spk2.php?id=$_GET[id]&id_b=$_SESSION[id_b]");
	}
else {
$file = file_get_contents("http://localhost/ALKES/json/pembuatan_spk2.php?id=$_GET[id]");
}
...
?>
  <tr>
    ...
    <td><font><?php echo date("d-m-Y H:i:s A",strtotime($json[$i]['tgl_lapor'])); ?></font></td>

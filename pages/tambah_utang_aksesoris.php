...
if (isset($_POST['tambah_header'])) {
	$Result = mysqli_query($koneksi, "insert into utang_piutang_aksesoris values('','Hutang','".$_POST['barang_pesan_akse_id']."','".$_POST['tgl_input']."','".$_POST['jatuh_tempo']."','".$_POST['nominal']."','".$_POST['klien']."','".$_POST['deskripsi']."','0')");
	if ($Result) {
...
function yesnoCheck() {
    ...
    if (document.getElementById('yesCheck').checked) {
        ...
        document.getElementById('ifYes').style.display = 'block';
              ...
              <br />
              <label>Pilih No PO</label>
              <select name="barang_pesan_akse_id" class="form-control">
                <option>-- PILIH NO PO --</option>
                <?php 
                $query = mysqli_query($koneksi,"SELECT id,no_po_pesan FROM barang_pesan_akse");

...
if (isset($_POST['tambah_header'])) {
	$Result = mysqli_query($koneksi, "insert into kategori_buku_kas values('','".$_POST['no_akun']."','".$_POST['nama_akun']."','".$_POST['akun_tipe']."','".$_POST['saldo']."')");
	if ($Result) {
        ...
        <section class="col-lg-4 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              ...
              <select required name="saldo" class="form-control">

async function hitungBaris(keyword) {
    ...
    let id_gudang = getVars("id_gudang").replace('#', '');
    if (keyword == '') {
...
async function loadMore(start, keyword) {
    ...
    if (keyword == '') {
        if (tgl1 === undefined && tgl2 === undefined) {
            console.log('test1');
            $.get("data/" + page + ".php?start=" + start + "&page=" + page + "&tampil=" + tampil + "&id_gudang=" + id_gudang,
                function (data) {
                    $('#table').html(data);
                }
            );
        ...
        if (tgl1 === undefined && tgl2 === undefined) {
            console.log('test3');
            $.get("data/" + page + ".php?start=" + start + "&page=" + page + "&cari=" + keyword + "&tampil=" + tampil + "&id_gudang=" + id_gudang,
                function (data) {
                    $('#table').html(data);
                }
            );

var tahun = getVars("thn");
var tahun_skrg = new Date().getFullYear();
...
async function hitungBaris(keyword) {
    ...
    if (keyword === '') {
        if (tgl1 === undefined && tgl2 === undefined) {
            if (tahun === undefined) {
                await $.get("json/" + page + ".php?tahun=" + tahun_skrg,
                    function (data) {
                        jmll = data;
                    }
                );
            } else {
                await $.get("json/" + page + ".php?tahun=" + tahun,
                    function (data) {
                        jmll = data;
                    }
                );
        ...
        if (tgl1 === undefined && tgl2 === undefined) {
            if (tahun === undefined) {
                await $.get("json/" + page + ".php?cari=" + keyword + "&tahun=" + tahun_skrg,
                    function (data) {
                        jmll = data;
                    }
                );
            } else {
                await $.get("json/" + page + ".php?cari=" + keyword + "&tahun=" + tahun,
                    function (data) {
                        jmll = data;
                    }
                );
...
async function loadMore(start, keyword) {
    ...
    if (keyword === '') {
        if (tgl1 === undefined && tgl2 === undefined) {
            if (tahun === undefined) {
                $.get("data/" + page + ".php?start=" + start + "&page=" + page + "&tampil=" + tampil + "&tahun=" + tahun_skrg,
                    function (data) {
                        $('#table').html(data);
                    }
                );
            } else {
                $.get("data/" + page + ".php?start=" + start + "&page=" + page + "&tampil=" + tampil + "&tahun=" + tahun,
                    function (data) {
                        $('#table').html(data);
                    }
                );
        ...
        if (tgl1 === undefined && tgl2 === undefined) {
            if (tahun === undefined) {
                $.get("data/" + page + ".php?start=" + start + "&page=" + page + "&cari=" + keyword + "&tampil=" + tampil + "&tahun=" + tahun_skrg,
                    function (data) {
                        $('#table').html(data);
                    }
                );
            } else {
                $.get("data/" + page + ".php?start=" + start + "&page=" + page + "&cari=" + keyword + "&tampil=" + tampil + "&tahun=" + tahun,
                    function (data) {
                        $('#table').html(data);
                    }
                );

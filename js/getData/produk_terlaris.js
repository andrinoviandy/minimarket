async function hitungBaris(keyword) {
    ...
    if (keyword == '') {
        if (tglLaris1 === undefined && tglLaris2 === undefined) {
            ...
            await $.get("json/" + page + ".php?tglLaris1=" + tglLaris1 + "&tglLaris2=" + tglLaris2,
                function (data) {
                    jmll = data;
                }
            );
        ...
        if (tglLaris1 === undefined && tglLaris2 === undefined) {
            ...
            await $.get("json/" + page + ".php?cari=" + keyword + "&tglLaris1=" + tglLaris1 + "&tglLaris2=" + tglLaris2,
                function (data) {
                    jmll = data;
                }
            );
...
async function loadMore(start, keyword) {
    ...
    if (keyword == '') {
        if (tglLaris1 === undefined && tglLaris2 === undefined) {
            ...
            console.log('test2');
            $.get("data/" + page + ".php?start=" + start + "&page=" + page + "&tampil=" + tampil + "&tglLaris1=" + tglLaris1 + "&tglLaris2=" + tglLaris2,
                function (data) {
                    $('#table').html(data);
                }
            );
        ...
        if (tglLaris1 === undefined && tglLaris2 === undefined) {
            ...
            console.log('test4');
            $.get("data/" + page + ".php?start=" + start + "&page=" + page + "&cari=" + keyword + "&tampil=" + tampil + "&tglLaris1=" + tglLaris1 + "&tglLaris2=" + tglLaris2,
                function (data) {
                    $('#table').html(data);
                }
            );

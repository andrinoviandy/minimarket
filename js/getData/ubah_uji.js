...
var id_rumkit = parseInt(getVars("id_rumkit"));
...
function hitungBaris(keyword) {
    ...
    if (keyword === '') {
        if (tgl1 === undefined && tgl2 === undefined) {
            xhr.open('GET', "json/" + page + ".php?id_rumkit=" + id_rumkit, true)
        } else {
            xhr.open('GET', "json/" + page + ".php?tgl1=" + tgl1 + "&tgl2=" + tgl2 + "&id_rumkit=" + id_rumkit , true)
        }
    } else {
        if (tgl1 === undefined && tgl2 === undefined) {
            xhr.open('GET', "json/" + page + ".php?cari=" + keyword + "&id_rumkit=" + id_rumkit, true)
        } else {
            xhr.open('GET', "json/" + page + ".php?cari=" + keyword + "&tgl1=" + tgl1 + "&tgl2=" + tgl2 + "&id_rumkit=" + id_rumkit, true)
        }
    }
    xhr.send()
}
...
function loadMore(start, keyword) {
    ...
    if (keyword === '') {
        if (tgl1 === undefined && tgl2 === undefined) {
            xhr.open('GET', "data/" + page + ".php?start=" + start + "&page=" + page + "&id_rumkit=" + id_rumkit, true)
        } else {
            xhr.open('GET', "data/" + page + ".php?start=" + start + "&page=" + page + "&id_rumkit=" + id_rumkit + "&tgl1=" + tgl1 + "&tgl2=" + tgl2, true)
        }
    } else {
        if (tgl1 === undefined && tgl2 === undefined) {
            xhr.open('GET', "data/" + page + ".php?start=" + start + "&page=" + page + "&cari=" + keyword + "&id_rumkit=" + id_rumkit, true)
        } else {
            xhr.open('GET', "data/" + page + ".php?start=" + start + "&page=" + page + "&cari=" + keyword + "&id_rumkit=" + id_rumkit + "&tgl1=" + tgl1 + "&tgl2=" + tgl2, true)
        }
    }
    xhr.send()

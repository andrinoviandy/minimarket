async function hitungBaris(keyword) {
    ...
    if (keyword == '') {
        if (tgl1 === undefined && tgl2 === undefined) {
            ...
            await $.get("json/" + page + ".php?tgl1=" + tgl1 + "&tgl2=" + tgl2 + "&id=" + id,
                function (data) {
                    jmll = data;
                }
            );
        ...
        if (tgl1 === undefined && tgl2 === undefined) {
            ...
            await $.get("json/" + page + ".php?cari=" + keyword + "&tgl1=" + tgl1 + "&tgl2=" + tgl2 + "&id=" + id,
                function (data) {
                    jmll = data;
                }
            );
...
async function loadMore(start, keyword) {
    ...
    if (keyword == '') {
        if (tgl1 === undefined && tgl2 === undefined) {
            console.log('test1');
            $.get("data/" + page + ".php?start=" + start + "&page=" + page + "&tampil=" + tampil + "&id=" + id,
                function (data) {
                    $('#table').html(data);
                }
            );
            ...
            console.log('test2');
            $.get("data/" + page + ".php?start=" + start + "&page=" + page + "&tampil=" + tampil + "&tgl1=" + tgl1 + "&tgl2=" + tgl2 + "&id=" + id,
                function (data) {
                    $('#table').html(data);
                }
            );
        ...
        if (tgl1 === undefined && tgl2 === undefined) {
            console.log('test3');
            $.get("data/" + page + ".php?start=" + start + "&page=" + page + "&cari=" + keyword + "&tampil=" + tampil + "&id=" + id,
                function (data) {
                    $('#table').html(data);
                }
            );
            ...
            console.log('test4');
            $.get("data/" + page + ".php?start=" + start + "&page=" + page + "&cari=" + keyword + "&tampil=" + tampil + "&tgl1=" + tgl1 + "&tgl2=" + tgl2 + "&id=" + id,
                function (data) {
                    $('#table').html(data);
                }
            );

...
<table width="100%" class="mytable" style="padding-left:20px">
  <tr>
    ...
    <td width="41%" align="center"><strong>Description</strong></td>
    <td width="9%" align="center"><strong>Qty</strong></td>
    <td width="11%" align="center"><strong>Unit Price</strong></td>
    <td width="15%" align="center"><strong>Diskon</strong></td>
    <td width="15%" align="center"><strong>Total Price</strong></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td align="right"><strong><?php echo $mata_uang['simbol']."".number_format($d['harga_total'],2,',','.'); ?></strong></td>
  </tr>
  ...
  <tr>
    <td colspan="5" align="right"><strong>Total Price + PPN(<?php echo $data['ppn']."%"; ?>) =</strong></td>

...
<body onLoad="window.print();" style="font-family:">
  ...
  <table width="100%">
    ...
    <tr>
      <td colspan="4" align="center"><strong><u>PURCHASE ORDER</u></strong><br>
        <strong>No. : <?php echo $data['no_po_pesan']; ?></strong>
      </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
  ...
  <table width="100%" style="padding-left:20px">
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td><br>
        <strong><?php echo $data['alamat_pengiriman']; ?></strong><br>
      </td>
    </tr>
    <tr>
      <td>4.</td>
  ...
  <div style="page-break-before:always;">
    ...
    <table width="100%" class="mytable" style="padding-left:20px">
      <tr>
        ...
        <td width="47%" align="center"><strong>Description</strong></td>
        ...
        <td width="13%" align="center"><strong>Total Price</strong></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      ?>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><strong><?php echo "Type   : " . strtoupper($brg['tipe_brg']); ?></strong></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><strong><?php echo "Brand  : " . strtoupper($brg['merk_brg']); ?></strong></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><strong style="padding-left:20px">Accessories :</strong></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        ?>
          <tr>
            ...
            <td align="center"><!--<?php echo "€ " . number_format(($d_akse['qty'] * $d_akse['harga_akse']) - (($d_akse['qty'] * $d_akse['harga_akse']) * $d['diskon'] / 100), 0, ',', ',') . ".00"; ?>--></td>
          </tr>
        <?php
        ...
        <tr>
          <td>&nbsp;</td>
          <td><strong style="padding-left:20px">Specification :</strong></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td>
            <?php
            $sel33 = mysqli_query($koneksi, "select * from spesifikasi where barang_gudang_id=" . $d['barang_gudang_id'] . " order by judul_spesifikasi ASC");
            while ($data_sel33 = mysqli_fetch_array($sel33)) {
              echo "<strong style='padding-left:20px'>" . $data_sel33['judul_spesifikasi'] . "</strong><br><font style='padding-left:20px'>" . $data_sel33['nama_spesifikasi'] . "</font><br><br>";
            }
            ?>
          </td>
          <td>&nbsp;</td>
      ...
      <tr>
        <td colspan="5" align="right"><strong>Harga PPN(<?php echo $data['ppn'] . "%"; ?>) =</strong></td>
        <td align="right"><strong><?php
                                  echo $data['simbol'] . "" . number_format($data['total_price'] * $data['ppn'] / 100, 2, ',', '.');
                                  //echo "€ ".number_format(($total_akse2+$total['total'])-(($total_akse2+$total['total'])*$data['ppn']/100),0,',',',').".00"; 
                                  ?></strong></td>
      </tr>
      <tr>
        <td colspan="5" align="right"><strong>Freight Cost by Air to JAKARTA =</strong></td>
        <td align="right"><strong><?php echo $data['simbol'] . "" . number_format($data['cost_byair'], 2, ',', '.'); ?></strong></td>
      </tr>
      <tr>
        <td colspan="5" align="right"><strong>Total Cost C&amp;F JAKARTA =</strong></td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><strong><?php //echo $data_sel3['judul_spesifikasi']; 
                ?></strong><br><br>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><p align="justify"><strong>Catatan : <?php //echo $data_sel['catatan_spek']; 
                                              ?></strong></p></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>

...
<body onLoad="window.print();" style="color:#000099">
  <table width="100%">
    <tr>
      ...
      <td width="42%" align="center">
        <font color="#000099" style="font-size:25px"><b>INSTALLATION REPORT</b></font>
      </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td align="center">
        <table width="300px" height="30px" class="mytable2">
          <tr>
  ...
  <table class="mytable">
    <tr valign="top">
      <td width="58%" style="padding:10px">
        <table width="100%">
          <tr height="30px">
  ...
  <table border="1" class="mytable" style="font-size: 12px;">
    ...
    ?>
      ...
      <tr height="30px">
        <td colspan="3" height="30px" align="center">Tidak Ada Aksesoris</td>
      </tr>
    <?php } ?>
  </table><br />

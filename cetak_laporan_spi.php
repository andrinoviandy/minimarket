...
header("Content-Disposition: attachment; filename=Rekapan SPI - ".date("d/m/Y", strtotime($_POST['tgl1']))." - ".date("d/m/Y", strtotime($_POST['tgl2'])).".xls");
?>
<?php require("config/koneksi.php"); ?>
<h2 align="center" style="margin-bottom:0px"><strong>PT. CIPTA VARIA KHARISMA UTAMA</strong></h2>
<center>
Rekapan Surat Perintah Instalasi 
<br />
...
// membuka file JSON
$file = file_get_contents("http://localhost/ALKES/json/spi.php?tgl1=".$_POST['tgl1']."&tgl2=".$_POST['tgl2']."");

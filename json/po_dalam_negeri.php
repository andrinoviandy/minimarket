...
$sql = "select *,barang_pesan.id as idd from barang_pesan where jenis_po='Dalam Negeri' and keuangan_id='$_GET[id_keuangan]' order by tgl_po_pesan DESC, barang_pesan.id DESC";
} else {
...
$sql = "select *,barang_pesan.id as idd from barang_pesan where jenis_po='Dalam Negeri' order by tgl_po_pesan DESC, barang_pesan.id DESC LIMIT 100";
}
}

...
if (isset($_GET['start'])) {
    if (isset($_GET['cari'])) {
        $sql = "select *,kasbon_perjalanan_dinas.id as idd from kasbon_perjalanan_dinas,kasbon_perjalanan_dinas_detail,barang_teknisi,barang_teknisi_detail,barang_dikirim_detail,barang_dikirim,barang_dijual,tb_teknisi,pembeli where barang_teknisi.id=kasbon_perjalanan_dinas_detail.barang_teknisi_id and barang_teknisi.id=barang_teknisi_detail.barang_teknisi_id and barang_dikirim_detail.id=barang_teknisi_detail.barang_dikirim_detail_id and barang_dikirim.id=barang_dikirim_detail.barang_dikirim_id and barang_dijual.id=barang_dikirim.barang_dijual_id and tb_teknisi.id=kasbon_perjalanan_dinas_detail.teknisi_id and pembeli.id=barang_dijual.pembeli_id and (date_format(tgl_kasbon, '%d-%m-%Y') like '%$_GET[cari]%' or no_kasbon like '%$_GET[cari]%' or no_spk like '%$_GET[cari]%' or barang_dijual.no_po_jual like '%$_GET[cari]%' or nama_pembeli like '%$_GET[cari]%' or nama_teknisi like '%$_GET[cari]%' or kasbon_perjalanan_dinas_detail.deskripsi like '%$_GET[cari]%') group by kasbon_perjalanan_dinas.id order by tgl_kasbon DESC,no_kasbon DESC LIMIT $start, $limit";
    } else {
        $sql = "select *,kasbon_perjalanan_dinas.id as idd from kasbon_perjalanan_dinas order by tgl_kasbon DESC,no_kasbon DESC LIMIT $start, $limit";
    }
    ...
    if (isset($_GET['cari'])) {
        $sql = "select COUNT(DISTINCT kasbon_perjalanan_dinas.id) as jml from kasbon_perjalanan_dinas,kasbon_perjalanan_dinas_detail,barang_teknisi,barang_teknisi_detail,barang_dikirim_detail,barang_dikirim,barang_dijual,tb_teknisi,pembeli where barang_teknisi.id=kasbon_perjalanan_dinas_detail.barang_teknisi_id and barang_teknisi.id=barang_teknisi_detail.barang_teknisi_id and barang_dikirim_detail.id=barang_teknisi_detail.barang_dikirim_detail_id and barang_dikirim.id=barang_dikirim_detail.barang_dikirim_id and barang_dijual.id=barang_dikirim.barang_dijual_id and tb_teknisi.id=kasbon_perjalanan_dinas_detail.teknisi_id and pembeli.id=barang_dijual.pembeli_id and (date_format(tgl_kasbon, '%d-%m-%Y') like '%$_GET[cari]%' or no_kasbon like '%$_GET[cari]%' or no_spk like '%$_GET[cari]%' or barang_dijual.no_po_jual like '%$_GET[cari]%' or nama_pembeli like '%$_GET[cari]%' or nama_teknisi like '%$_GET[cari]%' or kasbon_perjalanan_dinas_detail.deskripsi like '%$_GET[cari]%')";
    } else {
        $sql = "select COUNT(*) as jml from kasbon_perjalanan_dinas";
    }

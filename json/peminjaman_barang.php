...
if (isset($_GET['start'])) {
	...
	if ($_GET['tgl1'] && $_GET['tgl2']) {
		if (isset($_GET['cari'])) {
			$sql = "select COUNT(DISTINCT barang_pinjam.id) as jml from barang_pinjam,barang_dikirim,pembeli,barang_dijual,barang_pinjam_detail,barang_gudang_detail,barang_gudang where barang_gudang.id=barang_gudang_detail.barang_gudang_id and barang_gudang_detail.id=barang_pinjam_detail.barang_gudang_detail_id and barang_pinjam.id=barang_pinjam_detail.barang_pinjam_id and barang_dijual.id=barang_dikirim.barang_dijual_id and barang_dikirim.id=barang_pinjam.barang_dikirim_id and pembeli.id=barang_dijual.pembeli_id and (tgl_peminjaman like '%$_GET[cari]%' or kegiatan like '%$_GET[cari]%' or no_pengiriman like '%$_GET[cari]%' or nama_pembeli like '%$_GET[cari]%' or nama_brg like '%$_GET[cari]%' or no_seri_brg like '%$_GET[cari]%') and tgl_peminjaman between '$_GET[tgl1]' and '$_GET[tgl2]'";
		} else {
			$sql = "select COUNT(DISTINCT barang_pinjam.id) as jml from barang_pinjam,barang_dikirim,pembeli,barang_dijual where barang_dijual.id=barang_dikirim.barang_dijual_id and barang_dikirim.id=barang_pinjam.barang_dikirim_id and pembeli.id=barang_dijual.pembeli_id and tgl_peminjaman between '$_GET[tgl1]' and '$_GET[tgl2]'";
		}
	} else {
		if (isset($_GET['cari'])) {
			$sql = "select COUNT(DISTINCT barang_pinjam.id) as jml from barang_pinjam,barang_dikirim,pembeli,barang_dijual,barang_pinjam_detail,barang_gudang_detail,barang_gudang where barang_gudang.id=barang_gudang_detail.barang_gudang_id and barang_gudang_detail.id=barang_pinjam_detail.barang_gudang_detail_id and barang_pinjam.id=barang_pinjam_detail.barang_pinjam_id and barang_dijual.id=barang_dikirim.barang_dijual_id and barang_dikirim.id=barang_pinjam.barang_dikirim_id and pembeli.id=barang_dijual.pembeli_id and (tgl_peminjaman like '%$_GET[cari]%' or kegiatan like '%$_GET[cari]%' or no_pengiriman like '%$_GET[cari]%' or nama_pembeli like '%$_GET[cari]%' or nama_brg like '%$_GET[cari]%' or no_seri_brg like '%$_GET[cari]%')";
		} else {
			$sql = "select COUNT(DISTINCT barang_pinjam.id) as jml from barang_pinjam,barang_dikirim,pembeli,barang_dijual where barang_dijual.id=barang_dikirim.barang_dijual_id and barang_dikirim.id=barang_pinjam.barang_dikirim_id and pembeli.id=barang_dijual.pembeli_id";
		}
	}

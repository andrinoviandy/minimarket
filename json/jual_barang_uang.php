...
// } else {
    if (isset($_GET['start'])) {
        if (isset($_GET['tgl1']) && isset($_GET['tgl2'])) {
            if (isset($_GET['cari'])) {
                $sql = "select barang_dijual.*,barang_dijual.id as idd from barang_dijual left join barang_dijual_qty on barang_dijual.id = barang_dijual_qty.barang_dijual_id left join barang_gudang on barang_gudang.id = barang_dijual_qty.barang_gudang_id left join pembeli on pembeli.id = barang_dijual.pembeli_id where barang_dijual.status_awal=1 and (no_po_jual like '%$_GET[cari]%' or nama_pembeli like '%$_GET[cari]%' or nama_brg like '%$_GET[cari]%' or tipe_brg like '%$_GET[cari]%' or marketing like '%$_GET[cari]%' or subdis like '%$_GET[cari]%') and tgl_jual between '$_GET[tgl1]' and '$_GET[tgl2]' group by no_po_jual order by tgl_jual DESC, barang_dijual.id DESC LIMIT $start, $limit";
            } else {
            ...
            if (isset($_GET['cari'])) {
                $sql = "select barang_dijual.*,barang_dijual.id as idd from barang_dijual left join barang_dijual_qty on barang_dijual.id = barang_dijual_qty.barang_dijual_id left join barang_gudang on barang_gudang.id = barang_dijual_qty.barang_gudang_id left join pembeli on pembeli.id = barang_dijual.pembeli_id where barang_dijual.status_awal=1 and (no_po_jual like '%$_GET[cari]%' or nama_pembeli like '%$_GET[cari]%' or nama_brg like '%$_GET[cari]%' or tipe_brg like '%$_GET[cari]%' or marketing like '%$_GET[cari]%' or subdis like '%$_GET[cari]%') group by no_po_jual order by tgl_jual DESC, barang_dijual.id DESC LIMIT $start, $limit";
            } else {
        ...
        if ($_GET['tgl1'] && $_GET['tgl2']) {
            if (isset($_GET['cari'])) {
                $sql = "select COUNT(DISTINCT barang_dijual.id) as jml from barang_dijual left join barang_dijual_qty on barang_dijual.id = barang_dijual_qty.barang_dijual_id left join barang_gudang on barang_gudang.id = barang_dijual_qty.barang_gudang_id left join pembeli on pembeli.id = barang_dijual.pembeli_id where barang_dijual.status_awal=1 and (no_po_jual like '%$_GET[cari]%' or nama_pembeli like '%$_GET[cari]%' or nama_brg like '%$_GET[cari]%' or tipe_brg like '%$_GET[cari]%' or marketing like '%$_GET[cari]%' or subdis like '%$_GET[cari]%') and tgl_jual between '$_GET[tgl1]' and '$_GET[tgl2]'";
            } else {
            ...
            if (isset($_GET['cari'])) {
                $sql = "select COUNT(DISTINCT barang_dijual.id) as jml from barang_dijual left join barang_dijual_qty on barang_dijual.id = barang_dijual_qty.barang_dijual_id left join barang_gudang on barang_gudang.id = barang_dijual_qty.barang_gudang_id left join pembeli on pembeli.id = barang_dijual.pembeli_id where barang_dijual.status_awal=1 and (no_po_jual like '%$_GET[cari]%' or nama_pembeli like '%$_GET[cari]%' or nama_brg like '%$_GET[cari]%' or tipe_brg like '%$_GET[cari]%' or marketing like '%$_GET[cari]%' or subdis like '%$_GET[cari]%')";
            } else {

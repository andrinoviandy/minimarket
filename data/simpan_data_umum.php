...
$up2 = mysqli_query($koneksi, "update barang_dijual set tgl_jual='" . $_POST['tgl_jual'] . "', no_po_jual='" . $_POST['no_po'] . "', no_kontrak='" . $_POST['no_kontrak'] . "', pembeli_id='" . $_POST['pembeli'] . "',marketing='" . $_POST['marketing'] . "',subdis='" . $_POST['subdis'] . "',include_dpp='" . $_POST['dpp'] . "'  where id=" . $_POST['id'] . "");
if ($_POST['status_deal'] == 0) {
    ...
    mysqli_query($koneksi, "update utang_piutang set nominal=" . $neto . " where no_faktur_no_po='" . $_POST['no_po_jual'] . "'");
}
if ($up and $up2) {

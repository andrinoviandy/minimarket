...
<form method="post" enctype="multipart/form-data" onsubmit="simpanAlkes(); return false;">
    <div class="modal-body">
        ...
        <select name="id_akse" id="id_akse" style="width: 100%;" class="form-control select2" autofocus="autofocus" required onchange="changeValue(this.value); getNoSeri(this.value);">
            <option value="">...</option>
        ...
        <br />
        <label>No. Seri</label>
        <div id="noseri-peminjaman-barang">
...
<script type="text/javascript">
    ...
    function getNoSeri(id) {
        $.get("data/noseri-peminjaman-barang.php", {
                id: id
            },
            function(data) {
                $('#noseri-peminjaman-barang').html(data);
            }
        );

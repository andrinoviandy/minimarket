        ...
        <table class="table table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th valign="top">Harga Jual</th>
                    <th valign="top">Jumlah Terjual</th>
                    <th valign="top">Total Terjual</th>
                    <th valign="top">Stok Sebelumnya</th>
                    <th valign="top">Stok Sisa</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                ?>
                        <tr class="<?php echo $bg; ?>">
                            ...
                            <td><?php echo number_format($json[$i]['harga_jual'], 0, ',', '.'); ?></td>
                            <td><?php echo number_format($json[$i]['stok_terjual'], 0, ',', '.'); ?></td>
                            <td><?php echo number_format($json[$i]['harga_jual']*$json[$i]['stok_terjual'], 0, ',', '.'); ?></td>
                            <td><?php echo number_format($json[$i]['stok']+$json[$i]['stok_terjual'], 0, ',', '.'); ?></td>
                            <td><?php echo number_format($json[$i]['stok'], 0, ',', '.'); ?></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>

...
<form method="post" enctype="multipart/form-data" id="formUbah" onsubmit="ubahItem(); return false;">
    <div class="modal-body">
        ...
        <input name="qrcode" id="qrcode" required class="form-control" type="text" placeholder="" value="<?php echo $data['qrcode']; ?>"><br />
        <label>Expired</label>
        <input name="tgl_expired" id="tgl_expired" required class="form-control" type="date" placeholder="" value="<?php echo $data['tgl_expired']; ?>"><br />
    </div>

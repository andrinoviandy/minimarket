...
$sm = mysqli_query($koneksi, "update barang_dijual set ongkir=$ongkir, diskon_jual=$diskon, total_harga=$jml[total], ppn_jual=$ppn, pph=$pph, zakat=$zakat, biaya_bank=$biaya_bank, neto='" . $neto . "' where id=" . $_POST['idd'] . "");
if ($sm) {

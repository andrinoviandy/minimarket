    ...
    <table width="100%" id="example1" class="table table-bordered table-hover">
        <thead>
            <tr>
                ...
                <th width="" valign="top">Angsuran</th>
                <th width="" valign="top">Persen Bunga (%)</th>
                <th width="" valign="top">Nilai Bunga</th>
                <th width="" valign="top">Nominal Bayar</th>
        ...
        ?>
            <tr>
                ...
                <td><?php echo $json[$i]['angsuran'] !== NULL ? number_format($json[$i]['angsuran'], 0, ',', '.') : '-';  ?></td>
                <td><?php echo $json[$i]['persen_bunga']."%"; ?></td>
                <td><?php echo $json[$i]['bunga'] !== NULL ? number_format($json[$i]['bunga'], 0, ',', '.') : '-';  ?></td>
                <td><?php echo $json[$i]['nominal_bayar'] !== NULL ? number_format($json[$i]['nominal_bayar'], 0, ',', '.') : '-';  ?></td>

                ...
                <td align="center">
                    <?php if ($json[$i]['status_po_batal'] == 0) { ?>
                        <?php if (isset($_SESSION['pass_administrator'])) { ?>
                            <!-- <a href="index.php?page=pembelian_akse2&id_hapus=<?php echo $json[$i]['idd']; ?>" onclick="return confirm('Anda Yakin Akan Menghapus Item Ini ?')"> -->
                            <a onclick="hapus(<?php echo $json[$i]['idd']; ?>)" href="#">
                        ...
                        if ($cek_uang == 0 and isset($_SESSION['adminpoluar']) or isset($_SESSION['user_administrator'])) { ?>
                            <a href="index.php?page=ubah_pembelian_akse2&id=<?php echo $json[$i]['idd']; ?>">
                                <button class="btn btn-warning btn-xs">
                                    <span data-toggle="tooltip" title="Ubah" class="fa fa-folder-open"></span>
                                </button>
                            </a>
                        <?php } ?>
                        <a href="cetak_surat_po_pemesanan_akse_luar.php?id=<?php echo $json[$i]['idd']; ?>" target="_blank">
                        ...
                        <!-- <a href="index.php?page=pembelian_akse2&id_pulih=<?php echo $json[$i]['idd']; ?>" onclick="return confirm('Anda yakin akan memulihkan PO ini ?')"> -->

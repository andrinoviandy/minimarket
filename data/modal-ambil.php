...
<div class="form-group">
    <label>Nasabah</label>
    <select name="nasabah_id" id="nasabah_id" required class="form-control select2" style="width:100%" onchange="pilihTabungan2(this.value)">
        <option value="">...</option>
        <?php
...
<input type="hidden" name="setor_ambil" id="setor_ambil" value="2" />
<script>
    $(function() {
...
<script>
    function pilihTabungan2(value) {
        $.get("data/pilih_tabungan.php", {nasabah_id : value},
            function (data, textStatus, jqXHR) {
                $('#option_tabungan2').html(data);   
            }
        );
    }
</script>
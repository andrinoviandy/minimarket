    ...
    <table width="100%" id="example1" class="table table-bordered table-hover">
        ...
        ?>
                <tr>
                    ...
                    <td align="center">
                        <!-- <a href="index.php?page=simpan_tambah_pemesanan_alkes2_sudah_ada&id_hapus=<?php echo $data_akse['idd']; ?>" onclick="return confirm('Yakin Akan Menghapus Item Ini ?')"> -->
                        <button class="btn btn-xs btn-danger" onclick="hapus('<?php echo $data_akse['idd']; ?>')">
                        <span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></и>
                        <!-- <br /> -->
                        <!-- <a href="index.php?page=simpan_tambah_aksesoris_pesan2_sudah_ada&id=<?php echo $data_akse['id_gudang']; ?>"><small data-toggle="tooltip" title="Kelola Aksesoris" class="label bg-green"><span class="fa fa-cogs"></span>&nbsp Akse</small></a> -->
                    </td>
                </tr>
        <?php }
        } else {

...
$data_k = mysqli_fetch_array(mysqli_query($koneksi, "select COUNT(*) as jml from barang_dikirim_detail where barang_dijual_qty_id = $_GET[id_qty]"));
$data_hash = mysqli_fetch_array(mysqli_query($koneksi, "select COUNT(*) as jml from barang_dikirim_detail_hash where barang_dijual_qty_id = $_GET[id_qty]"));
?>

...
header("Content-Disposition: attachment; filename=Detail Riwayat Buku Kas - $da[nama_akun] - $s.xls");
?>
<h3 align="center"><strong>Detail Riwayat Hutang &amp; Piutang</strong></h3>

<p><b>Buku Kas : <?php echo $da['nama_akun']; ?></b><br />Tgl Cetak : <?php echo date('d M Y');?></p>

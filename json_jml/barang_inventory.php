...
if (isset($_GET['start'])) {
    ...
    if (isset($_GET['cari'])) {
        $sql = "select * from barang_inventory where nama_brg like '%$_GET[cari]%' or merk_brg like '%$_GET[cari]%' or tipe_brg like '%$_GET[cari]%' or negara_asal like '%$_GET[cari]%' or deskripsi_alat like '%$_GET[cari]%' group by barang_inventory.id";
    } else {
        $sql = "select * from barang_inventory group by barang_inventory.id";
    }
}

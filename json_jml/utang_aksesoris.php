...
$sql = "select *,utang_piutang_aksesoris.id as idd from utang_piutang_aksesoris where u_p='Hutang' and nominal!=0 order by tgl_input DESC, utang_piutang_aksesoris.id DESC LIMIT $curr, $limit";
 }

...
<body onLoad="window.print();" style="font-family:">
  ...
  <table width="100%" style="padding-left:20px">
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td><strong><?php //echo $data['catatan']; 
                  ?></strong></td>
    </tr>
  </table>
  <br><br>
    ...
    <table width="100%" class="mytable" style="padding-left:20px">
      ...
      ?>
        ...
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><strong><?php //echo "Brand  : ".strtoupper($brg['merk_brg']); 
                      ?></strong><strong style="padding-left:20px">Specification :</strong></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td><?php
              $sel3 = mysqli_query($koneksi, "select * from spesifikasi where barang_gudang_id=" . $d['barang_gudang_id'] . " order by judul_spesifikasi ASC");
              while ($data_sel3 = mysqli_fetch_array($sel3)) {
                echo "<strong style='padding-left:20px'>" . $data_sel3['judul_spesifikasi'] . "</strong><br><font style='padding-left:20px'>" . $data_sel3['nama_spesifikasi'] . "</font><br><br>";
              }
              ?></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>

    ...
    <table width="100%" class="mytable">
        ...
        ?>
            <tr>
                ...
                <td valign="top"><?php echo $d['nama_brg'] . "<br>"; ?>
        ...
        <?php } ?>
        <tr>
            <td colspan="2" align="center" valign="top">1 Paket</td>
        ...
        <tr>
            ...
            <td align="right" valign="top"><?php
                                            $diskon_ppn = $data['ppn_jual'] / 100 * $total_ongkir;
                                            if ($data['ppn_jual'] != 0) {
        ...
        <tr>
            ...
            <td align="right" valign="top" style="font-size:20px"><strong><?php echo "Rp" . number_format(($diskon_ppn + $total_ongkir), 0, ',', '.');

                                                                            $TOT = ($diskon_ppn + $total_ongkir);
                                                                            ?></strong></td>
        </tr>
        <tr>

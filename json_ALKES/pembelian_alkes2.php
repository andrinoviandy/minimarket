...
$sql = "select *,barang_pesan.id as idd from barang_pesan where jenis_po='Luar Negeri' and keuangan_id='$_GET[id_keuangan]' order by tgl_po_pesan DESC, barang_pesan.id DESC LIMIT $curr, $limit";
} else {
...
$sql = "select *,barang_pesan.id as idd from barang_pesan where jenis_po='Luar Negeri' order by tgl_po_pesan DESC, barang_pesan.id DESC LIMIT $curr, $limit";
}
}

  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview <?php echo $po; ?>"><a href="#">
          ...
          <i>(P)</i> <span><strong>&nbsp; Purchase Order</strong></span>
          <span class="pull-right-container">
      ...
      <li class="treeview <?php echo $gudang; ?>">
        <!-- <a href="#"><i>(G)</i> <span><strong style="color:#0C0"><em>GUDANG</em></strong> -->
        <a href="#"><i>(G)</i> <span><strong>&nbsp; Gudang</strong>
      ...
      <li class="treeview <?php echo $bagian_teknisi; ?>">
        <!-- <a href="#"><i>(T)</i> <span><strong style="color:#F90"><em> TEKNISI</em></strong></span> -->
        <a href="#"><i>(T)</i> <span><strong>&nbsp; Teknisi</strong></span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span></a>
        <ul class="treeview-menu">
      ...
      <li class="treeview <?php echo $bagian_keuangan; ?>">
        <!-- <a href="#"><i>(K)</i> <span><strong style="color:#CC0"><em> KEUANGAN</em></strong></span> -->
        <a href="#"><i>(K)</i> <span><strong>&nbsp; Keuangan</strong></span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span></a>
        <ul class="treeview-menu">
      ...
      <li class="treeview <?php echo $bagian_cs; ?>">
        <a href="#"><i>(C)</i> <span><strong>&nbsp; Customer Service</strong></span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span></a>
        <ul class="treeview-menu">
          <li class="<?php echo $akun_user; ?>">
            <a href="index.php?page=pembeli">
              <i class="fa fa-users"></i> <span class="">Customer</span></a>
          </li>

...
if ($total_row > 0) {
	...
	if ($total_roww > 0) {
		...
		if ($total_rowww > 0) {
			...
			$_SESSION['nama'] = $dataa['nama_teknisi'];
			$_SESSION['user'] = $user;
			$_SESSION['waktu_login'] = strval(date('d/m/Y H:i:s'));
		...
		window.location='index.php?page=beranda';
													...
													$queri7 = mysqli_query($koneksi, "select * from akun_manajer_marketing where username='$user' and password='$pass'");
													$total_row7 = mysqli_num_rows($queri7);
													$data7 = mysqli_fetch_array($queri7);
													if ($total_row7 > 0) {
														session_start();
														...
														$_SESSION['user'] = $user;
														$_SESSION['waktu_login'] = strval(date('d/m/Y H:i:s'));
														$_SESSION['user_manajer_marketing'] = $user;

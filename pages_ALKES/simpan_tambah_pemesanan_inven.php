...
if (isset($_POST['tambah_header'])) {
	...
	window.location='index.php?page=simpan_tambah_pemesanan_inven'</script>";
		}
}
...
if (isset($_POST['simpan_tambah_aksesoris'])) {
	...
	echo "<script>window.location='index.php?page=simpan_tambah_pemesanan_inven'</script>";
	}
...
<div class="content-wrapper">
  ...
  <thead>
    <tr>
      ...
      <td align="center" valign="bottom"><strong>Aksi</strong></td></tr>
  </thead>
...
";
  ...
  <tr>
    ...
    <td align="center"><a href="index.php?page=simpan_tambah_pemesanan_inven&id_hapus=<?php echo $data_akse['idd']; ?>" onclick="return confirm('Yakin Akan Menghapus Item Ini ?')"><span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></a></td>
    </tr>
  <?php }} else {
    ...
    <tr>
    <td colspan="6" align="right" valign="bottom"><strong>Freight Cost by Air to JAKARTA =</strong></td>
    <td align="center" valign="top"><input id="cost_byair" name="cost_byair" class="form-control" onkeyup="sum_total_keseluruhan();" type="text" placeholder="" size="10"/></td>
    <td align="center"></td>
    <td align="center"></td>
    </tr>
    <tr>
...
function yesnoCheck() {
    if (document.getElementById('yesCheck').checked) {
        document.getElementById('ifYes').style.display = 'block';
              ...
              <label>Nominal</label>
              <input name="nominal" id="nominal" class="form-control" type="text" placeholder="Dalam Rupiah" value=""><br />
              <label>Klien</label>
       <input name="klien" class="form-control" type="text" placeholder="" value="<?php echo $_SESSION['nama_princ']; ?>" required="required"><br />

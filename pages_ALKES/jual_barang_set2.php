...
if (isset($_POST['lapor'])) {
	$cek = mysqli_num_rows(mysqli_query($koneksi, "select * from barang_dijual_set where no_faktur_jual = '".$_POST['no_faktur']."'"));
	if ($cek == 0) {
	...
	echo "<script type='text/javascript'>
		...
		$_SESSION['provinsi']=$_POST['provinsi2'];
		$_SESSION['kecamatan']=$_POST['kecamatan2'];
		$_SESSION['kabupaten']=$_POST['kabupaten2'];
		...
		echo "<script>alert('Maaf, No PO Sudah Ada')</script>";
		}
}
	?>

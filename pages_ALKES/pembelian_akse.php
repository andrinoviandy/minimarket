...
if (isset($_GET['id_pulih'])) {
	...
	if ($up) {
		echo "<script>window.location='index.php?page=pembelian_akse'</script>";
		} 
	}
?>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            <div class="box-footer">
              ...
              <a href="index.php?page=pembelian_akse#openPilihan">
...
// membuka file JSON
$file = file_get_contents("http://localhost/ALKES/json/po_dalam_negeri_akse.php");
...
?>
  <tr bgcolor="<?php echo $bg; ?>">
    ...
    <a href="index.php?page=pembelian_akse&id_hapus=<?php echo $json[$i]['idd']; ?>" onclick="return confirm('Anda Yakin Akan Menghapus Item Ini ?')"><span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></a>&nbsp;<?php } ?>
    <?php
	...
	if ($cek_uang==0 and isset($_SESSION['adminpodalam']) or isset($_SESSION['user_administrator'])) { ?>
    <a href="index.php?page=ubah_pembelian_akse&id=<?php echo $json[$i]['idd']; ?>"><span data-toggle="tooltip" title="Ubah" class="fa fa-edit"></span></a>
    <?php } ?>
    <br />
    <a href="cetak_surat_po_pemesanan_akse1.php?id=<?php echo $json[$i]['idd']; ?>" target="_blank"><span data-toggle="tooltip" title="Cetak 1" class="fa fa-print"></span></a>
    <a href="cetak_surat_po_pemesanan_akse2.php?id=<?php echo $json[$i]['idd']; ?>" target="_blank"><span data-toggle="tooltip" title="Cetak 2" class="fa fa-print"></span></a>
    <?php 
    ...
    <br />
    <a href="index.php?page=pembelian_akse&id=<?php echo $json[$i]['idd']; ?>#openBatal"><small data-toggle="tooltip" title="Batalkan PO" class="label bg-red">Batalkan</small></a>
    <?php } }  else { ?>
    <a href="index.php?page=pembelian_akse&id_pulih=<?php echo $json[$i]['idd']; ?>" onclick="return confirm('Anda yakin akan memulihkan PO ini ?')"><small data-toggle="tooltip" title="Pulihkan PO" class="label bg-green">Pulihkan PO</small></a>
...
<div id="openPilihan" class="modalDialog">
     <div>
        ...
        <br />
        <a href="index.php?page=tambah_pembelian_akse"><button id="buttonn">Data Principle Baru</button></a>
        <a href="index.php?page=tambah_pembelian_akse_sudah_ada">

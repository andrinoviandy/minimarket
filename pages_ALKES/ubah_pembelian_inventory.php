<?php
$query = mysqli_query($koneksi, "select *,principle.id as id_principle from barang_pesan_inventory,principle,mata_uang where principle.id=barang_pesan_inventory.principle_id and mata_uang.id=barang_pesan_inventory.mata_uang_id and barang_pesan_inventory.id='".$_GET['id']."'");
...
if (isset($_POST['simpan_perubahan'])) {
	...
	if ($Result) {
		...
		window.location='index.php?page=pembelian_inventory'
		</script>";
		}
	}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Ubah Pemesanan Barang Inventory</h1><ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="index.php?page=barang_masuk">Pemesanan</a></li>
        <li class="active">Ubah Pemesanan</li></ol></section>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Detail Barang</h3></div><div class="box-body">
              <a href="index.php?page=tambah_po_inventory&id=<?php echo $_GET['id']; ?>">
        ...
        <section class="col-lg-6 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
             ...
             <?php if (isset($_SESSION['user_administrator']) or isset($_SESSION['adminpodalam'])) { ?>
              <a href="index.php?page=ubah_pembelian_inventory&id=<?php echo $_GET['id']; ?>#openBaru"><button name="ubah_baru" class="btn btn-success" type="submit"><span class="fa fa-edit"></span> Ubah Dengan Data Yang Baru</button></a>
              <a href="index.php?page=ubah_pembelian_inventory&id=<?php echo $_GET['id']; ?>#openSudahAda"><button name="ubah_sudah_ada" class="btn btn-success pull pull-right" type="submit"><span class="fa fa-edit"></span> Ubah Dengan Data Yang Sudah Ada</button></a>
              <?php } ?>
              <br /><br />
...
if ($sel) {
	...
	echo "<script type='text/javascript'>
		 window.location='index.php?page=ubah_pembelian_inventory&id=$_GET[id]'
		</script>";
	}
}
?>

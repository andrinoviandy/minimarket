...
if (isset($_POST['tambah_laporan'])) {
	...
	$Result = mysqli_query($koneksi, "update peserta_pelatihan set nama_peserta='".$dat."' where pelatihan_alat_id=".$_GET['id']."");
	if ($Result) {
        ...
        <section class="col-lg-6 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
			  ...
			  for ($i=0; $i<$data['banyak_peserta']; $i++) {
			  ?>
              <input name="peserta[]" class="form-control" type="text" required placeholder="Nama Peserta Ke-<?php echo $i+1; ?>" autofocus><br />
              <?php } ?>

...
if (isset($_POST['tambah_aksesoris'])) {
	...
	//}
	$jml = mysqli_num_rows(mysqli_query($koneksi, "select * from barang_pesan_akse where no_po_pesan='".$_POST['no_po']."'"));
	if ($jml==0) {
	...
	echo "<script type='text/javascript'>
	window.location='index.php?page=simpan_tambah_pemesanan_akse2_sudah_ada';
		</script>";
	} else {
		echo "<script type='text/javascript'>
...
";
        ...
        <?php 
		$jsArray .= "dtBrg['" . $d['id'] . "'] = {alamat:'".addslashes(str_replace("<br>","[Enter]",substr($d['alamat_principle'],0,20)))."...........',

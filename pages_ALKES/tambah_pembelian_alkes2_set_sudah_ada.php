...
if (isset($_POST['tambah_aksesoris'])) {
	...
	echo "<script type='text/javascript'>
	window.location='index.php?page=simpan_tambah_pemesanan_alkes2_set_sudah_ada';
		</script>";
...
";
        ...
        <?php 
		$jsArray .= "dtBrg['" . $d['id'] . "'] = {alamat:'".addslashes(str_replace("<br>","[Enter]",substr($d['alamat_principle'],0,30)))."...........',

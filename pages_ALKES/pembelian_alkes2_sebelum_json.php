...
<div class="content-wrapper">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            <div class="box-footer">
              ...
              <a href="index.php?page=pembelian_alkes2#openPilihan">
  ...
  <?php
	  ...
	  $query = mysqli_query($koneksi, "select *,barang_pesan.id as idd from barang_pesan where jenis_po='Luar Negeri' order by tgl_po_pesan DESC");

        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            <div class="box-footer">
              ...
              <a href="index.php?page=pembelian_alkes2_set#openPilihan">
...
// membuka file JSON
$file = file_get_contents("http://localhost/ALKES/json/po_luar_negeri_set.php");
...
?>
  <tr bgcolor="<?php echo $bg; ?>">
    ...
    <a href="index.php?page=pembelian_alkes2_set&id_hapus=<?php echo $json[$i]['idd']; ?>" onclick="return confirm('Anda Yakin Akan Menghapus Item Ini ?')"><span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></a>&nbsp;<?php } ?><a href="index.php?page=ubah_pembelian_alkes2_set&id=<?php echo $json[$i]['idd']; ?>"><span data-toggle="tooltip" title="Ubah" class="fa fa-edit"></span></a><br />
    <a href="cetak_surat_po_pemesanan_set.php?id=<?php echo $json[$i]['idd']; ?>" target="_blank"><span data-toggle="tooltip" title="Cetak PO" class="fa fa-print"></span></a>
    <?php 
	$j_cek=mysqli_num_rows(mysqli_query($koneksi, "select * from barang_pesan_set_detail,barang_gudang_set where barang_gudang_set.id=barang_pesan_set_detail.barang_gudang_set_id and barang_pesan_set_detail.barang_pesan_set_id=".$json[$i]['idd']." and status_ke_stok=1"));
	if ($cek_uang==0 and $j_cek==0) { ?>
    <br />
    <a href="index.php?page=pembelian_alkes2_set&id=<?php echo $json[$i]['idd']; ?>#openBatal"><small data-toggle="tooltip" title="Batalkan PO" class="label bg-red">Batalkan</small></a>
    <?php } } else { ?>
    <a href="index.php?page=pembelian_alkes2_set&id_pulih=<?php echo $json[$i]['idd']; ?>" onclick="return confirm('Anda yakin akan memulihkan PO ini ?')"><small data-toggle="tooltip" title="Pulihkan PO" class="label bg-green">Pulihkan PO</small></a>
...
<div id="openPilihan" class="modalDialog">
     <div>
        ...
        <br />
        <a href="index.php?page=tambah_pembelian_alkes2_set"><button id="buttonn">Data Principle Baru</button></a>
        <a href="index.php?page=tambah_pembelian_alkes2_set_sudah_ada">
...
if (isset($_POST['batal'])) {
	$up=mysqli_query($koneksi, "update barang_pesan_set set status_po_batal=1,deskripsi_batal='".$_POST['deskripsi']."' where id=".$_GET['id']."");
	if ($up) {
		echo "<script>window.location='index.php?page=pembelian_alkes2_set'</script>";
		} 
	}

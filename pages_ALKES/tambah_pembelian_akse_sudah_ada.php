...
if (isset($_POST['tambah_aksesoris'])) {
	...
	echo "<script type='text/javascript'>
	window.location='index.php?page=simpan_tambah_pemesanan_akse_sudah_ada';
		</script>";
	} else {
		echo "<script type='text/javascript'>
...
";
        ...
        <?php 
		$jsArray .= "dtBrg['" . $d['id'] . "'] = {alamat_princ:'".addslashes(str_replace("<br>","[Enter]",substr($d['alamat_principle'],0,30)))."............',

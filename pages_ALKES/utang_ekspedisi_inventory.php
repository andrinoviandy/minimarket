...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Biaya Ekspedisi (Inventory)</h1>
      <ol class="breadcrumb">
...
?>
  <tr>
    <td align="center"><?php echo $i+1; ?></td>
     <?php
    $jumlah_bayar = mysqli_fetch_array(mysqli_query($koneksi, "select sum(nominal) as total from bayar_ekspedisi_inventory where barang_dikirim_inventory_id=".$json[$i]['idd'].""));
	...
	?>
    <td>
      <a href="index.php?page=bayar_ekspedisi_inventory&id=<?php echo $json[$i]['idd']; ?>"><small data-toggle="tooltip" title="Riwayat Pembayaran" class="label bg-green"> Riwayat Pembayaran </small></a>
    </td>
  </tr>
  <?php } ?>
</table><br />

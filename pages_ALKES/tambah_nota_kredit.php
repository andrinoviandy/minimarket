...
if (isset($_POST['tambah_header'])) {
	$Result = mysqli_query($koneksi, "INSERT into nota_kredit values('','$_POST[tanggal]','$_POST[pelanggan_id]','".$_POST['deskripsi']."','".$_POST['pilihan_biaya_id']."','".$_POST['harga']."')");
	if ($Result) {
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><span class="active">Tambah Nota Kredit</span></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Nota Kredit</li>
        <li class="active">Tambah Nota Kredit</li>
      </ol>
    </section>
        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Tambah <span class="active">Nota Kredit</span></h3>
            </div>
              <div class="box-body">
              <form method="post">
              <label>Tanggal</label>
              ...
              <select name="pelanggan_id" class="form-control" required="required">
              <option>-- Pilih Pemasok --</option>
              <?php 
              $query = mysqli_query($koneksi,"SELECT id,nama_pelanggan FROM pelanggan");

...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Mutasi Barang Set</h1><ol class="breadcrumb">
  ...
  <?php
  $q = mysqli_query($koneksi, "select *,barang_pesan_set_detail.id as idd,barang_gudang_set.id as id_gudang from barang_gudang_set,barang_pesan_set_detail,barang_pesan_set where barang_gudang_set.id=barang_pesan_set_detail.barang_gudang_set_id and barang_pesan_set.id=barang_pesan_set_detail.barang_pesan_set_id and barang_pesan_set.id=".$_GET['id']."");
  $no=0;
  ...
  <tr>
	...
	if ($d['status_ke_stok']==0) { ?>
    <a href="index.php?page=mutasi_set&id=<?php echo $_GET['id']; ?>&stok_set=<?php echo $d['qty']; ?>&id_gudang=<?php echo $d['id_gudang']; ?>&id_detail=<?php echo $d['idd']; ?>#openPilihan"><small data-toggle="tooltip" title="Mutasi & Tambah Ke Stok" class="label bg-green"><span class="fa fa-share"></span> Stok</small></a>
...
<div id="openPilihan" class="modalDialog">
     <div>
        <a href="#" title="Close" class="close">X</a>
        <br />
        <a href="index.php?page=mutasi_set_1&id=<?php echo $_GET['id']; ?>&stok_set=<?php echo $_GET['stok_set']; ?>&id_gudang=<?php echo $_GET['id_gudang']; ?>&id_detail=<?php echo $_GET['id_detail']; ?>"><button id="buttonn">Data Set Baru</button></a>
        <a href="index.php?page=simpan_tambah_barang_set33&id=<?php echo $_GET['id']; ?>&stok_set=<?php echo $_GET['stok_set']; ?>&id_gudang=<?php echo $_GET['id_gudang']; ?>&id_detail=<?php echo $_GET['id_detail']; ?>"><button id="buttonn">Sama Dengan Data Set Yang Lama</button></a>
    </div>
</div>

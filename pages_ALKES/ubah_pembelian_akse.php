...
if (isset($_POST['simpan_perubahan'])) {
	...
	if ($Result) {
		...
		window.location='index.php?page=pembelian_akse'
		</script>";
		}
	}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Ubah Pemesanan Aksesoris</h1><ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="index.php?page=barang_masuk">Pemesanan</a></li>
        <li class="active">Ubah Pemesanan Aksesoris</li></ol></section>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Detail Aksesoris</h3></div><div class="box-body">
              <a href="index.php?page=tambah_po_akse&id=<?php echo $_GET['id']; ?>">
              <button class="btn btn-success"><span class="fa fa-edit"></span> &nbsp;Kelola</button></a><strong class="pull pull-right">
              <table>
  <tr>
        ...
        <section class="col-lg-6 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
             ...
             <?php if (isset($_SESSION['user_administrator']) or isset($_SESSION['adminpodalam'])) { ?>
              <a href="index.php?page=ubah_pembelian_akse&id=<?php echo $_GET['id']; ?>#openBaru"><button name="ubah_baru" class="btn btn-success" type="submit"><span class="fa fa-edit"></span> Ubah Dengan Data Yang Baru</button></a>
              <a href="index.php?page=ubah_pembelian_akse&id=<?php echo $_GET['id']; ?>#openSudahAda"><button name="ubah_sudah_ada" class="btn btn-success pull pull-right" type="submit"><span class="fa fa-edit"></span> Ubah Dengan Data Yang Sudah Ada</button></a>
              <?php } ?>
              <br /><br />
...
if ($sel) {
	...
	echo "<script type='text/javascript'>
		 window.location='index.php?page=ubah_pembelian_akse&id=$_GET[id]'
		</script>";
	}
}
?>

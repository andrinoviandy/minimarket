...
if (isset($_POST['simpan_barang'])) {
		$simpan = mysqli_query($koneksi, "insert into aksesoris values('', '".$_SESSION['nama_akse']."', '".$_SESSION['merk']."', '".$_SESSION['tipe']."','".$_SESSION['nie']."','".$_SESSION['stok']."','".$_SESSION['negara_asal']."','".$_SESSION['deskripsi']."','".$_SESSION['harga_beli']."','".$_SESSION['harga_jual']."')");
...
<div class="content-wrapper">
  ...
  <thead>
    <tr>
      <td align="center" valign="bottom">Data Aksesoris Ke-</td>

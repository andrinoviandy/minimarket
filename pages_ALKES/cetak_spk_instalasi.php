...
$document = str_replace("#NAMAALKES", $barang, $document);
$document = str_replace("#MERK", $merk, $document);
$document = str_replace("#TIPE", $tipe, $document);$document = str_replace("#NOSERI", $no_seri, $document);
$document = str_replace("#NIE", $nie, $document);
$document = str_replace("#NAMADINAS", $pembeli, $document);

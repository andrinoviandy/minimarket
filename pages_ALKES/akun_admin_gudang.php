...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Admin Gudang</li></ol></section>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box-footer">
            <div class="box-body table-responsive no-padding">
              <div class="">
              <a href="index.php?page=tambah_admin_gudang"><input type="submit" name="button" id="button" value="Tambah" class="btn btn-success"/></a><br /><br />
  ...
  <?php
	  ...
	  $query = mysqli_query($koneksi, "select * from akun_admin_gudang order by nama ASC");

...
if (isset($_POST['tambah_header'])) {
	...
	window.location='index.php?page=simpan_tambah_pemesanan_akse2_sudah_ada'</script>";
		}
}
...
if (isset($_POST['simpan_tambah_aksesoris'])) {
	...
	echo "<script>window.location='index.php?page=simpan_tambah_pemesanan_akse2_sudah_ada'</script>";
	}
...
";
  ...
  <tr>
    ...
    <td align="center"><a href="index.php?page=simpan_tambah_pemesanan_akse2_sudah_ada&id_hapus=<?php echo $data_akse['idd']; ?>" onclick="return confirm('Yakin Akan Menghapus Item Ini ?')"><span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></a></td>
    </tr>
  <?php }} else {
...
<center><a href="index.php?page=simpan_tambah_pemesanan_akse2_sudah_ada#open_utang"><button name="simpan_barang" class="btn btn-success" type="button"><span class="fa fa-plus"></span> Simpan</button></a>&nbsp;&nbsp;<a href="index.php?page=pembelian_alkes2"><button name="batal" class="btn btn-success" type="button"><span class="fa  fa-times-circle"></span> Batal</button></a></center>
...
function yesnoCheck() {
    if (document.getElementById('yesCheck').checked) {
        document.getElementById('ifYes').style.display = 'block';
              ...
              <label>Nominal</label>
              <input id="" name="nominal" class="form-control" type="text" placeholder="" value=""><br />
              <label>Klien</label>

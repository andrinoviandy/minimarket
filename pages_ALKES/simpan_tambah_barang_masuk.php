...
if (isset($_POST['simpan_barang'])) {
	if ($_POST['stok']<=0) {
		$insert = mysqli_query($koneksi, "insert into barang_gudang values('','".$_SESSION['nama_barang']."','".$_SESSION['nie_brg']."','".$_SESSION['tipe']."','".$_SESSION['merk']."','".$_SESSION['negara_asal']."','".$_SESSION['jenis_barang']."','0','".$_SESSION['deskripsi_alat']."','".$_SESSION['harga_beli']."','".$_SESSION['harga']."','".$_SESSION['satuan']."','0')");
		if ($insert) {
...
<div class="content-wrapper">
  ...
  <tr>
    ...
    <td><?php echo $_SESSION['jenis_barang']; ?></td>

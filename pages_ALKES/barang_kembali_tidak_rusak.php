...
if (isset($_GET['id_hapus'])) {
	...
	if ($update and $update2 and $del and $del2) {
		...
		window.location='index.php?page=barang_kembali_tidak_rusak';
		</script>";
		}
	else {
		echo "<script type='text/javascript'>
...
// membuka file JSON
$file = file_get_contents("http://localhost/ALKES/json/barang_kembali_tidak_rusak.php");
...
?>
  <tr>
    ...
    <a href="index.php?page=barang_kembali_tidak_rusak&id_hapus=<?php echo $json[$i]['idd']; ?>" onclick="return confirm('Anda Yakin Akan Menghapus Item Ini ?')"><span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></a> &nbsp;<!--<a href="index.php?page=ubah_barang_kembali_tidak_rusak&id=<?php echo $json[$i]['idd']; ?>"><span data-toggle="tooltip" title="Ubah" class="fa fa-edit"></span></a>&nbsp; --><a href="cetak_surat_kembali_tidak_rusak.php?id=<?php echo $json[$i]['idd']; ?>" target="_blank"><span data-toggle="tooltip" title="Cetak Retur Pengembalian" class="fa fa-print"></span></a>
      <?php } ?>
<?php if (isset($_SESSION['user_admin_gudang']) && isset($_SESSION['pass_admin_gudang'])) { ?>
<!--<a href="index.php?page=ubah_barang_kembali_tidak_rusak&id=<?php echo $json[$i]['idd']; ?>"><span data-toggle="tooltip" title="Ubah" class="fa fa-edit"></span></a>&nbsp;--> <a href="cetak_surat_kembali.php?id=<?php echo $json[$i]['idd']; ?>" target="_blank"><span data-toggle="tooltip" title="Cetak Retur Pengembalian" class="fa fa-print"></span></a>
<?php } ?>
      <!-- Tombol Jual -->

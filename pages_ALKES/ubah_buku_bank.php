...
if (isset($_POST['tambah_laporan'])) {
	...
	if ($Result) {
		...
		alert('Buku Bank Berhasil Di Ubah !');
		window.location='index.php?page=buku_bank&id=$_GET[id]'
		</script>";
		}
	}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Ubah Buku Bank</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Buku Bank</li>
        ...
        <section class="col-lg-3 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Ubah <span class="active">Buku Bank</span></h3>
            </div>
              <div class="box-body">
              <form method="post">
              <label>No. Akun</label>
              ...
              <input name="akun_tipe" class="form-control" type="text" required placeholder="" value="<?php echo $data['tipe_akun']; ?>"><br />
              <label>Saldo Total (Rp <?php echo number_format($data['saldo'],2,',','.'); ?>)</label>
              
              <input name="saldo" class="form-control" type="text" placeholder="" value="<?php echo $data['saldo']; ?>"><br />
...
<?php /* ?>
          ...
          <div class="box box-success"><!-- /.chat -->
            <div class="box-footer">
            <div class="box-header with-border">
              <h3 class="box-title">Riwayat  Hutang &amp; Piutang</h3>
  ...
  <tr>
    ...
    <td><!--<a href="index.php?page=ubah_buku_kas&id=<?php echo $_GET['id']; ?>&id_hapus=<?php echo $data['idd']; ?>" onclick="return confirm('Anda Yakin Akan Menghapus Item Ini ?')"><span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></a>&nbsp;&nbsp;<a href="index.php?page=ubah_buku_kas&id=<?php echo $_GET['id']; ?>&id_ubah=<?php echo $data['idd']; ?>#openUbah"><span data-toggle="tooltip" title="Ubah" class="fa fa-edit"></span></a>-->
    <a href="index.php?page=detail_buku_kas&id=<?php echo $_GET['id']; ?>&id_up=<?php echo $data['id_up']; ?>"><span data-toggle="tooltip" title="Detail" class="fa fa-toggle-right"></span></a>
    </td>
  </tr>
  <?php } ?>
</table>

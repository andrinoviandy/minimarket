<?php 
$query = mysqli_query($koneksi, "select *,principle.id as id_principle from barang_pesan_akse,principle where principle.id=barang_pesan_akse.principle_id and barang_pesan_akse.id='".$_GET['id']."'");
...
if (isset($_POST['simpan_barang'])) {
	...
	window.location='index.php?page=ubah_pembelian_akse2&id=$_GET[id]'</script>";
		}
	}
...
if (isset($_POST['simpan_tambah_aksesoris'])) {
	...
	echo "<script>
alert('Berhasil Di Simpan ! Harap isi kembali Ongkir nya !');	window.location='index.php?page=tambah_po_akse2&id=$_GET[id]'</script>";
...
if (isset($_GET['id_hapus'])) {
	...
	mysqli_query($koneksi, "update barang_pesan_akse set cost_byair=0, cost_cf=0 where id=$_GET[id]");
	echo "<script type='text/javascript'>
	alert('Harap isi kembali Ongkir nya !');	window.location='index.php?page=tambah_po_akse2&id=$_GET[id]';
		</script>";
	}
?>
...
";
    ...
    <td align="center"><input id="harga_perunit" name="harga_perunit" class="form-control" type="text" required="required" onkeyup="sum();" size="10"/></td>
  ...
  <tr>
    ...
    <td align="center"><a href="index.php?page=tambah_po_akse2&id_ubah=<?php echo $data_akse['idd']; ?>&id=<?php echo $_GET['id']; ?>#open_ubah" ><span data-toggle="tooltip" title="Hapus" class="fa fa-edit"></span></a>&nbsp;&nbsp;<a href="index.php?page=tambah_po_akse2&id_hapus=<?php echo $data_akse['idd']; ?>&id=<?php echo $_GET['id']; ?>" onclick="return confirm('Yakin Akan Menghapus Item Ini ?')"><span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></a></td>
    </tr>
  <?php }} else {
...
<center><a href="index.php?page=tambah_po_akse2&id=<?php echo $_GET['id']; ?>"><button name="simpan_barang" class="btn btn-success" type="submit"><span class="fa fa-check"></span> Simpan</button></a></center>
</form>
</div>
              </div>
            </div>

...
if (isset($_POST['tambah_laporan'])) {
	$Result = mysqli_query($koneksi, "update admin_po_luar set nama='".$_POST['nama']."', username='".$_POST['user']."', password='".md5($_POST['pass'])."' where id=$_GET[id]");
	if ($Result) {
...
$data = mysqli_fetch_array(mysqli_query($koneksi, "select * from admin_po_luar where id=".$_GET['id'].""));
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Admin PO Luar Negeri</li>
        <li class="active">Ubah Admin PO Luar Negeri</li></ol></section>
        ...
        <section class="col-lg-4 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Ubah Admin PO Luar Negeri</h3></div><div class="box-body">
              <form method="post">
              <label>Nama</label>

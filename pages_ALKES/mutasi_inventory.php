...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Mutasi Barang Inventory</h1><ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="index.php?page=barang_masuk">Pemesanan</a></li>
        <li class="active">Mutasi Inventory</li></ol></section>
  ...
  <?php
  $q = mysqli_query($koneksi, "select *,barang_pesan_inventory_detail.id as idd,barang_inventory.id as id_gudang from barang_inventory,barang_pesan_inventory_detail,barang_pesan_inventory,mata_uang where mata_uang.id=barang_pesan_inventory.mata_uang_id and barang_inventory.id=barang_pesan_inventory_detail.barang_inventory_id and barang_pesan_inventory.id=barang_pesan_inventory_detail.barang_pesan_inventory_id and barang_pesan_inventory.id=".$_GET['id']."");
  $no=0;
  ...
  <tr>
    ...
    <a href="index.php?page=mutasi_inventory2&id=<?php echo $_GET['id']; ?>&stok_set=<?php echo $d['qty']; ?>&id_gudang=<?php echo $d['id_gudang']; ?>&id_detail=<?php echo $d['idd']; ?>#openPilihan"><small data-toggle="tooltip" title="Mutasi & Tambah Ke Stok" class="label bg-green"><span class="fa fa-share"></span> Stok</small></a>

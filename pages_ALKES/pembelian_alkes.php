...
?>
  <tr bgcolor="<?php echo $bg; ?>">
    ...
    <td><?php echo $json[$i]['no_po_pesan']; ?></td>
      ...
      <td>
	  <a href="#" data-toggle="modal" data-target="#modal-principle<?php echo $json[$i]['idd']; ?>"><small data-toggle="tooltip" title="Detail Principle" class="label bg-primary"><span class="fa fa-folder-open"></span></small></a></td>
    ...
    <a href="index.php?page=pembelian_alkes&id_hapus=<?php echo $json[$i]['idd']; ?>" onclick="return confirm('Anda Yakin Akan Menghapus Item Ini ?')"><span data-toggle="tooltip" title="Hapus" class="ion-android-delete"></span></a>&nbsp;<?php } ?>
    <?php
	...
	?>
    <a href="index.php?page=ubah_pembelian_alkes&id=<?php echo $json[$i]['idd']; ?>"><span data-toggle="tooltip" title="Ubah" class="fa fa-edit"></span></a>
    <?php } ?>
    <br />
    <a href="cetak_surat_po_pemesanan2.php?id=<?php echo $json[$i]['idd']; ?>" target="_blank"><span data-toggle="tooltip" title="Cetak 1" class="fa fa-print"></span></a>
    <a href="cetak_surat_po_pemesanan_dalam_negeri.php?id=<?php echo $json[$i]['idd']; ?>" target="_blank"><span data-toggle="tooltip" title="Cetak 2" class="fa fa-print"></span></a>
    <?php 
    ...
    <br />
    <!--<a href="index.php?page=pembelian_alkes&id=<?php echo $json[$i]['idd']; ?>#openBatal"><small data-toggle="tooltip" title="Batalkan PO" class="label bg-red">Batalkan</small></a>-->
    ...
    <?php } } else { ?>
    <a href="index.php?page=pembelian_alkes&id_pulih=<?php echo $json[$i]['idd']; ?>" onclick="return confirm('Anda yakin akan memulihkan PO ini ?')"><small data-toggle="tooltip" title="Pulihkan PO" class="label bg-green">Pulihkan PO</small></a>

...
if (isset($_POST['tambah_header'])) {
	...
	window.location='index.php?page=simpan_tambah_pemesanan_alkes2'</script>";
		}
}
...
if (isset($_POST['simpan_tambah_aksesoris'])) {
	...
	echo "<script>window.location='index.php?page=simpan_tambah_pemesanan_alkes2'</script>";
	}

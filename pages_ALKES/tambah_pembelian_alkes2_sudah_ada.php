...
$insert_princ = mysqli_query($koneksi, "insert into principle values('','".$_POST['nama_princ']."','".$_POST['alamat_princ']."','".$_POST['telp_princ']."','".$_POST['fax_princ']."','".$_POST['attn_princ']."')");
if ($insert_princ) {
...
if (isset($_POST['tambah_aksesoris'])) {
	...
	//}
	$jml = mysqli_num_rows(mysqli_query($koneksi, "select * from barang_pesan where no_po_pesan='".$_POST['no_po']."'"));
	if ($jml==0) {
	...
	echo "<script type='text/javascript'>
	window.location='index.php?page=simpan_tambah_pemesanan_alkes2_sudah_ada';
		</script>";
	} else {
		echo "<script type='text/javascript'>
        ...
        <section class="col-lg-6 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              ...
              Tanggal PO
              <input name="tgl_po" class="form-control" type="date"  placeholder="" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" autofocus="autofocus" ><br />
              No PO
...
";
        ...
        <?php 
		$jsArray .= "dtBrg['" . $d['id'] . "'] = {alamat:'".addslashes(str_replace("<br>","[Enter]",substr($d['alamat_principle'],0,15)))."...........',
    ...
    <br />
    Alamat Principle
              <textarea name="alamat_princ" rows="4" class="form-control" id="alamat_princ" placeholder="" disabled="disabled"></textarea><br />
              Telp. Principle
	...
	function changeValue(id_akse){  
		document.getElementById('alamat_princ').value=dtBrg[id_akse].alamat; 
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" align="center">Tambah Data Principle</h4>
              </div>
              <form method="post" enctype="multipart/form-data">
              <div class="modal-body">
                <strong>Nama Principle</strong>
              <input name="nama_princ" class="form-control" type="text" placeholder="" ><br />
             <strong> Alamat Principle</strong> 

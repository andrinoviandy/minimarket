                  ...
                  ?>
                    <tr>
                      ...
                      <td align="center"><?php
										  ...
										  $stok_po_set1 = mysqli_fetch_array(mysqli_query($koneksi, "select sum(qty_barang_gudang*qty_set) as stok_po_set from barang_dijual_qty_set_detail,barang_dijual_qty_set where barang_dijual_qty_set.id=barang_dijual_qty_set_detail.barang_dijual_qty_set_id and barang_gudang_id=" . $json[$i]['idd'] . ""));
										  $stok_po_set2 = mysqli_num_rows(mysqli_query($koneksi, "select * from barang_dikirim_set_detail,barang_gudang_detail where barang_gudang_detail.id=barang_dikirim_set_detail.barang_gudang_detail_id and barang_gudang_id=" . $json[$i]['idd'] . ""));
                                          if ($stok_po1['stok_po'] - $stok_po2 != 0 or $stok_po_set1['stok_po_set'] - $stok_po_set2 != 0) {
                                            echo ($stok_po1['stok_po'] - $stok_po2) + ($stok_po_set1['stok_po_set'] - $stok_po_set2);
                                          }
                                          ?>
                      ...
                      <td style="background-color:<?php echo $color; ?>"><?php
                                                                          echo $stok_total - (($stok_po1['stok_po'] - $stok_po2) + ($stok_po_set1['stok_po_set'] - $stok_po_set2));
                                                                          ?></td>
                      <td align="center"><?php
                      ...
                      <td align="center">
                        ...
                        <?php } ?>
                        <?php if (isset($_SESSION['user_pjt']) && isset($_SESSION['pass_pjt'])) { ?>
                          <a href="index.php?page=ubah_barang_masuk&id=<?php echo $json[$i]['idd']; ?>"><small class="label bg-primary"><span data-toggle="tooltip" title="Lihat" class="fa fa-eye"></span></small></a>
                        <?php } ?>

...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      Alkes Dalam Negeri</h1><ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Laporan Penjualan Alkes Dalam Negeri</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            <div class="box-footer">
              <div class="row">
              <div class="box-body">
              Tanggal Pesan PO (Dalam Negeri) : <br /><br />
              <form method="post" action="cetak_laporan_pembelian_alkes1.php">
              <div class="col-xs-3">

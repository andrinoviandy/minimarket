<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Deposit Ke Gudang</li>
      </ol>
    </section>
          ...
          <div class="box box-info"><!-- /.chat -->
            <div class="box-footer">
              ...
              <div class="col-xs-3">
                ...
                <button class="btn btn-success" type="submit"><span class="fa fa-print"></span> Cetak Biaya Deposit</button>
              </form>
              <?php } ?>
  ...
  <thead>
    <tr>
      <th align="center">#</th>
      <th align="center"><strong>Tanggal Deposit</strong></th>
      <th align="center">No Faktur</th>
      <th align="center"><strong>Nama Alkes</strong><span class="pull pull-right">No Seri</span></th>
...
// membuka file JSON
$file = file_get_contents("http://localhost/ALKES/json/deposit.php");
...
?>
  <tr>
    ...
    <table width="100%" border="0">
      <?php 
	  $q2=mysqli_query($koneksi, "select *,barang_dijual_detail.id as id_det_jual from barang_dijual_detail,barang_dijual,barang_gudang_detail,barang_gudang where barang_dijual.id=barang_dijual_detail.barang_dijual_id and barang_gudang_detail.id=barang_dijual_detail.barang_gudang_detail_id and barang_gudang.id=barang_gudang_detail.barang_gudang_id and barang_dijual_detail.barang_dijual_id=".$json[$i]['idd']."");
	  $n=0;
      ...
      <tr bgcolor="<?php echo $col; ?>">
        ...
        <?php
        $q4 = mysqli_num_rows(mysqli_query($koneksi , "select * from barang_dikirim_detail where barang_dijual_detail_id=".$d1['id_det_jual'].""));
		if ($q4!=0) {
		?>
    ...
    <td><a href="index.php?page=jual_barang&id=<?php echo $json[$i]['pembeli_id']; ?>#openDetailPembeli" style="color:#060" data-toggle="tooltip" title="Detail Dinas/RS/Puskesmas/Klinik/Dll"><?php 
    ...
    <a href="index.php?page=ubah_barang_jual2&id=<?php echo $json[$i]['idd']; ?>"><span data-toggle="tooltip" title="Ubah" class="fa fa-edit"></span></a><br /><?php } ?><?php 

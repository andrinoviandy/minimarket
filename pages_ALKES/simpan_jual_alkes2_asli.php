...
";
  ...
  $no=0;
  $q_akse = mysqli_query($koneksi, "select *,barang_dijual_hash.id as idd from barang_dijual_hash,barang_gudang_detail,barang_gudang where barang_gudang.id=barang_gudang_detail.barang_gudang_id and barang_gudang_detail.id=barang_dijual_hash.barang_gudang_detail_id and barang_dijual_hash.akun_id=".$_SESSION['id']."");
  ...
  <tr>
    ...
    <td align="center"><?php echo $data_akse['harga_satuan']; ?></td>

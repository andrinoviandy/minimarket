...
if (isset($_POST['tambah_header'])) {
	$Result = mysqli_query($koneksi, "insert into utang_piutang_aksesoris values('','Piutang','".$_POST['barang_pesan_akse_id']."','".$_POST['tgl_input']."','".$_POST['jatuh_tempo']."','".$_POST['nominal']."','".$_POST['klien']."','".$_POST['deskripsi']."','0')");
	if ($Result) {
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><span class="active">Tambah Piutang Aksesoris</span></h1>
      <ol class="breadcrumb">
        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Tambah <span class="active">Piutang / Debit</span></h3>
            </div>
              <div class="box-body">
...
function yesnoCheck() {
    ...
    if (document.getElementById('yesCheck').checked) {
        ...
        document.getElementById('ifYes').style.display = 'block';
              ...
              <br />
              <label>No PO</label>
                <select name="barang_pesan_akse_id" class="form-control">
                    <?php
                    $query1 = mysqli_query($koneksi,"SELECT id,no_po_pesan FROM barang_pesan_akse");
                    if (mysqli_num_rows($query1) > 0) {
                        while ($row = mysqli_fetch_array($query1)) {
                    ?>
                    <option value="<?php echo $row['id'];?>"><?php echo $row['no_po_pesan'];?></option>
                        <?php }}?>
                </select>
              <label>Nominal</label>

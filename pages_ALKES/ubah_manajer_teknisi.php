...
if (isset($_POST['tambah_laporan'])) {
	$Result = mysqli_query($koneksi, "update akun_manajer_teknisi set nama='".$_POST['nama']."', username='".$_POST['user']."', password='".md5($_POST['pass'])."' where id=$_GET[id]");
	if ($Result) {
		echo "<script type='text/javascript'>
		alert('Data Berhasil Di Ubah !');
		window.location='index.php?page=akun_manajer_teknisi'
		</script>";
		}
	}
...
$data = mysqli_fetch_array(mysqli_query($koneksi, "select * from akun_manajer_teknisi where id=".$_GET['id'].""));
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Ubah Manajer Teknisi</li>
      </ol>
    </section>
        ...
        <section class="col-lg-4 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Ubah Manajer Teknisi</h3>
            </div>
              <div class="box-body">
              <form method="post">
              <label>Nama</label>

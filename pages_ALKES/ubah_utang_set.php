<?php
$data=mysqli_fetch_array(mysqli_query($koneksi, "select * from utang_piutang_set where id=$_GET[id]"));

if (isset($_POST['tambah_header'])) {
	$Result = mysqli_query($koneksi, "update utang_piutang_set set tgl_input='".$_POST['tgl_input']."',jatuh_tempo='".$_POST['jatuh_tempo']."',nominal='".$_POST['nominal']."',klien='".$_POST['klien']."',deskripsi='".$_POST['deskripsi']."' where id=$_GET[id]");
	if ($Result) {
		echo "<script type='text/javascript'>
		alert('Data Berhasil Di Ubah !');
		window.location='index.php?page=utang_set'
		</script>";
		}
	}
?>

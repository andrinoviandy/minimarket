...
<div class="content-wrapper">
  ...
  <tr>
    ...
    <input id="cekbox" style="height:20px; width:20px" type="checkbox" class="minimal" name="pilih[]" value="<?php echo $data_detail['id']; ?>" onClick="run();">
    <?php } else {
		echo "Sudah Terjual";
		} ?>
    </td>
...
<div class="col-md-12"><!-- /.box -->
     ...
     <input class="form-control" type="email" placeholder="XXX@xxxx.com" name="email" required><br />
            	...
            	<input name="lapor" type="submit" value="Jual Alkes" class="form-control btn btn-success" id="cb"/>

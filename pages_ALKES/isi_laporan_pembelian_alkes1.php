...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 align="center">
        Laporan Pembelian Alkes Dalam Negeri</h1>
</section>
  ...
  <?php
	 ...
	 $query = mysqli_query($koneksi, "select * from barang_pesan,barang_pesan_detail,mata_uang,principle,barang_gudang where barang_gudang.id=barang_pesan_detail.barang_gudang_id and barang_pesan.id=barang_pesan_detail.barang_pesan_id and principle.id=barang_pesan.principle_id and mata_uang.id=barang_pesan.mata_uang_id and jenis_po='Dalam Negeri' and tgl_po_pesan between '$tgl1' and '$tgl2' order by tgl_po_pesan DESC");  
  $no=0;

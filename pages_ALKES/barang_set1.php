...
?>
  ...
  echo $json[$i]['simbol']." ".number_format($json[$i]['total_price'],0,',',',').".00";
    ...
    <?php if ($json[$i]['status_po_batal']==0){ ?>
      <a href="index.php?page=barang_set1&id=<?php echo $json[$i]['idd']; ?>#openLunas"><small data-toggle="tooltip" title="Tgl Masuk Gudang" class="label bg-green">Tgl Masuk Gudang</small></a><br />

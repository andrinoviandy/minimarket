...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><span class="active">Tambah Buku Kas</span></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Buku Kas</li>
        <li class="active">Tambah Buku Kas</li>
      </ol>
    </section>
        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Tambah <span class="active">Buku Kas</span></h3>
            </div>
              <div class="box-body">
              <form method="post">
              <label>No. Akun</label>
              ...
              <input name="akun_tipe" class="form-control" type="text" placeholder="" value="KAS" readonly="readonly"><br />

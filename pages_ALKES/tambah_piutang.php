...
if (isset($_POST['tambah_header'])) {
	$Result = mysqli_query($koneksi, "insert into utang_piutang values('','Piutang','','".$_POST['tgl_input']."','".$_POST['jatuh_tempo']."','".$_POST['nominal']."','".$_POST['klien']."','".$_POST['deskripsi']."','0')");
	if ($Result) {
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><span class="active">Tambah Piutang</span></h1>
      <ol class="breadcrumb">

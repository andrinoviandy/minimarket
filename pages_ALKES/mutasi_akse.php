...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Mutasi Aksesoris</h1><ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="index.php?page=barang_masuk">Pemesanan</a></li>
        <li class="active">Mutasi Alkes</li></ol></section>
  ...
  <?php
  $q = mysqli_query($koneksi, "select *,barang_pesan_akse_detail.id as idd from aksesoris,barang_pesan_akse_detail,barang_pesan_akse,mata_uang where mata_uang.id=barang_pesan_akse.mata_uang_id and aksesoris.id=barang_pesan_akse_detail.aksesoris_id and barang_pesan_akse.id=barang_pesan_akse_detail.barang_pesan_akse_id and barang_pesan_akse.id=".$_GET['id']."");
  $no=0;
  ...
  <tr>
    ...
    <a href="index.php?page=simpan_tambah_ke_stok_akse&id_pesan=<?php echo $_GET['id']; ?>&id=<?php echo $d['aksesoris_id']; ?>&id_detail=<?php echo $d['idd']; ?>&stok=<?php echo $d['qty']-$stok_sudah_mutasi['stok_sudah']; ?>"><small data-toggle="tooltip" title="Mutasi & Tambah Ke Stok" class="label bg-green"><span class="fa fa-share"></span> Masukkan Stok</small></a>
    <?php } else { echo "Sudah Masuk Stok"; }
	?>
    <?php if ($stok_sudah_mutasi['stok_sudah']!='') { ?>
    <br />
    <a href="index.php?page=detail_mutasi_akse&id=<?php echo $_GET['id']; ?>&id_gudang=<?php echo $d['aksesoris_id']; ?>&id_detail=<?php echo $d['idd']; ?>"><small data-toggle="tooltip" title="Riwayat Mutasi" class="label bg-blue"><span class="fa fa-calendar"></span> &nbsp;Riwayat Mutasi</small></a>
    <?php } ?>
    </td>
  </tr>
  <?php } ?>

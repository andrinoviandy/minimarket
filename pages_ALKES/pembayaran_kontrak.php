...
if (isset($_GET['id_hapus'])) {
	$del2 = mysqli_query($koneksi, "delete from kontrak_pembayaran where id=".$_GET['id_hapus']."");
	}
?>
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>Pembayaran Kontrak</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Pembayaran Kontrak</li>
      </ol>
    </section>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            <div class="box-footer">
              ...
              <a href="index.php?page=tambah_pembayaran_kontrak">
  ...
  <thead>
    <tr>
      ...
      <th width="" valign="top">Waktu Pembayaran</th>
      <th width="" align="center" valign="top">Nominal</th>
  ...
  <?php
  $file = file_get_contents("http://localhost/ALKES/json/pembayaran_kontrak.php");
...
for ($i=0; $i<$jml; $i++) { 
  ...
  <tr>
    ...
    <td><?php echo $json[$i]['no_kontrak']; ?></td>
      ...
      <td><?php echo date("d/m/Y",strtotime($json[$i]['tgl_pembayaran'])); ?></td>

...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Barang Inventory</li>
      </ol>
    </section>
...
// membuka file JSON
$file = file_get_contents("http://localhost/ALKES/json/barang_inventory1.php");
...
?>
  ...
  echo $json[$i]['simbol']." ".number_format($json[$i]['total_price'],0,',',',').".00";
    ...
    <?php if ($json[$i]['status_po_batal']==0){ ?>
      <a href="index.php?page=barang_inventory1&id=<?php echo $json[$i]['idd']; ?>#openLunas"><small data-toggle="tooltip" title="Tgl Masuk Gudang" class="label bg-green">Tgl Masuk Gudang</small></a><br />
...
if (isset($_POST['lunasin'])) {
	$q_lunas=mysqli_query($koneksi, "update barang_pesan_inventory set tgl_masuk_gudang='".$_POST['tgl_lunas']."' where id=$_GET[id]");
	if ($q_lunas) {

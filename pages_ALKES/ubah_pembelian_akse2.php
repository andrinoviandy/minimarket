<?php
$query = mysqli_query($koneksi, "select *,principle.id as id_principle from barang_pesan_akse,principle,mata_uang where principle.id=barang_pesan_akse.principle_id and mata_uang.id=barang_pesan_akse.mata_uang_id and barang_pesan_akse.id='".$_GET['id']."'");
...
if (isset($_GET['id_hapus'])) {
	mysqli_query($koneksi, "delete from barang_pesan_akse_detail where id=".$_GET['id_hapus']."");
	}

if (isset($_POST['simpan_perubahan'])) {
	$ppn=$_POST['ppn']/100;
	$up_uang = mysqli_query($koneksi, "update utang_piutang_aksesoris set no_faktur_no_po_akse='".$_POST['no_po']."' where no_faktur_no_po_akse='".$data['no_po_pesan']."'");
	$Result = mysqli_query($koneksi, "update barang_pesan_akse set tgl_po_pesan='".$_POST['tgl_po']."',no_po_pesan='".$_POST['no_po']."',ppn='".$_POST['ppn']."',cara_pembayaran='".$_POST['cara_pembayaran']."', mata_uang_id='".$_POST['mata_uang']."',alamat_pengiriman='".str_replace("\n","<br>",$_POST['alamat_pengiriman'])."',jalur_pengiriman='".$_POST['jalur_pengiriman']."',estimasi_pengiriman='".$_POST['estimasi_pengiriman']."', catatan='".$_POST['catatan']."' where id=".$_GET['id']."");
	if ($Result) {
		mysqli_query($koneksi, "update barang_pesan_akse_detail set mata_uang_id=".$_POST['mata_uang']." where barang_pesan_akse_id=".$_GET['id']."");
		echo "<script type='text/javascript'>
		alert('Data Berhasil Diubah !');
		window.location='index.php?page=pembelian_akse2'
		</script>";
		}
	}
?>
...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <a href="index.php?page=tambah_po_akse2&id=<?php echo $_GET['id']; ?>">
  ...
  <?php
  $q = mysqli_query($koneksi, "select *,barang_pesan_akse_detail.id as idd from aksesoris,barang_pesan_akse_detail,barang_pesan_akse,mata_uang where aksesoris.id=barang_pesan_akse_detail.aksesoris_id and barang_pesan_akse.id=barang_pesan_akse_detail.barang_pesan_akse_id and mata_uang.id=barang_pesan_akse_detail.mata_uang_id and barang_pesan_akse.id=".$_GET['id']."");
  $no=0;
        ...
        <section class="col-lg-6 connectedSortable">
          ...
          <div class="box box-success"><!-- /.chat -->
            ...
            <div class="box-header with-border">
              ...
              <a href="index.php?page=ubah_pembelian_akse2&id=<?php echo $_GET['id']; ?>#openBaru"><button name="ubah_baru" class="btn btn-success" type="submit"><span class="fa fa-edit"></span> Ubah Dengan Data Yang Baru</button></a>
              <a href="index.php?page=ubah_pembelian_akse2&id=<?php echo $_GET['id']; ?>#openSudahAda"><button name="ubah_sudah_ada" class="btn btn-success pull pull-right" type="submit"><span class="fa fa-edit"></span> Ubah Dengan Data Yang Sudah Ada</button></a>
              <br /><br />
...
$nilai_m = $max['id_max'];
if ($sel) {
	$upd_brg_pesan = mysqli_query($koneksi, "update barang_pesan_akse set principle_id=$nilai_m where id=$_GET[id]");
	echo "<script type='text/javascript'>
		 window.location='index.php?page=ubah_pembelian_akse2&id=$_GET[id]'
		</script>";
	}
}
?>
...
$upd_brg_pesan = mysqli_query($koneksi, "update barang_pesan_akse set principle_id=".$_POST['id_akse']." where id=$_GET[id]");
if ($upd_brg_pesan) {

...
<br />
                <center>
                <a href="index.php?page=tambah_po_alkes2_set&id=<?php echo $_GET['id']; ?>"><button name="simpan_barang" class="btn btn-success" type="submit"><span class="fa fa-check"></span> Kembali ke halaman sebelumnya</button></a></center>
              </div>
              </div>
            </div>
          </div>
